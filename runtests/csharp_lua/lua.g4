...
: nempty_list_o_stat_p__0__1=stat { 
                $result = new MyList<stmt> { _localctx.nempty_list_o_stat_p__0__1.result };
            }
| nempty_list_o_stat_p__1__1=nempty_list_o_stat_p_ nempty_list_o_stat_p__1__2=stat { 
                $result = (MyList<stmt>) appendList<stmt>((MyList<stmt>) _localctx.nempty_list_o_stat_p__1__1.result, (stmt) _localctx.nempty_list_o_stat_p__1__2.result);
            }
;
...
| allow_empty_o_nempty_list_o_stat_p__p__1__1=nempty_list_o_stat_p_ { 
                $result = _localctx.allow_empty_o_nempty_list_o_stat_p__p__1__1.result;
            }
;
list_o_stat_p_ returns [MyList<stmt> result]
: list_o_stat_p__0__1=allow_empty_o_nempty_list_o_stat_p__p_ { 
                $result = _localctx.list_o_stat_p__0__1.result;
            }
;
opt_o_retstat_p_ returns [maybe<stmt> result]
: opt_o_retstat_p__0__1=retstat { 
                $result = (maybe<stmt>) some<stmt>((stmt) _localctx.opt_o_retstat_p__0__1.result);
            }
|  { 
...
: opt_o__i__h__i__p__0__1=';' { 
                $result = (maybe<IToken>) some<IToken>((IToken) _localctx.opt_o__i__h__i__p__0__1);
            }
|  { 
...
: nempty_list_o_elseif_p__0__1=elseif { 
                $result = new MyList<if_elseif> { _localctx.nempty_list_o_elseif_p__0__1.result };
            }
| nempty_list_o_elseif_p__1__1=nempty_list_o_elseif_p_ nempty_list_o_elseif_p__1__2=elseif { 
                $result = (MyList<if_elseif>) appendList<if_elseif>((MyList<if_elseif>) _localctx.nempty_list_o_elseif_p__1__1.result, (if_elseif) _localctx.nempty_list_o_elseif_p__1__2.result);
            }
;
...
| allow_empty_o_nempty_list_o_elseif_p__p__1__1=nempty_list_o_elseif_p_ { 
                $result = _localctx.allow_empty_o_nempty_list_o_elseif_p__p__1__1.result;
            }
;
list_o_elseif_p_ returns [MyList<if_elseif> result]
: list_o_elseif_p__0__1=allow_empty_o_nempty_list_o_elseif_p__p_ { 
                $result = _localctx.list_o_elseif_p__0__1.result;
            }
;
opt_o_else_p_ returns [maybe<if_else> result]
: opt_o_else_p__0__1=else__x_ { 
                $result = (maybe<if_else>) some<if_else>((if_else) _localctx.opt_o_else_p__0__1.result);
            }
|  { 
...
| stat_1__1=nempty_seplist_o__i__s__i__s_exp_p_ '=' stat_1__3=nempty_seplist_o__i__s__i__s_exp_p_ { 
...
| stat_9__1='if' stat_9__2=exp 'then' stat_9__4=block stat_9__5=list_o_elseif_p_ stat_9__6=opt_o_else_p_ 'end' { 
                $result = (stmt) IfStmt((IToken) _localctx.stat_9__1, (expr) _localctx.stat_9__2.result, (block) _localctx.stat_9__4.result, (MyList<if_elseif>) _localctx.stat_9__5.result, (maybe<if_else>) _localctx.stat_9__6.result);
            }
...
| stat_11__1='for' stat_11__2=nempty_seplist_o__i__s__i__s__i_name_k__p_ 'in' stat_11__4=nempty_seplist_o__i__s__i__s_exp_p_ 'do' stat_11__6=block 'end' { 
...
| stat_12__1='local' 'function' stat_12__3=funcname '(' stat_12__5=opt_o_parlist_p_ ')' stat_12__7=block 'end' { 
                $result = (stmt) ExprStmt((expr) (expr) FuncDef((IToken) _localctx.stat_12__1, (bool) true, (maybe<funcname>) (maybe<funcname>) some<funcname>((funcname) _localctx.stat_12__3.result), (maybe<parameters>) _localctx.stat_12__5.result, (block) _localctx.stat_12__7.result));
            }
| 'local' stat_13__2=nempty_seplist_o__i__s__i__s__i_name_k__p_ stat_13__3=opt_assign_rhs { 
...
| atom_5__1=NESTED_STR { 
                $result = (expr) String((IToken) _localctx.atom_5__1);
            }
| atom_6__1='...' { 
                $result = (expr) Ellipse((IToken) _localctx.atom_6__1);
            }
| atom_7__1=functiondef { 
                $result = _localctx.atom_7__1.result;
            }
| atom_8__1=tableconstructor { 
                $result = (expr) TableExpr((table) _localctx.atom_8__1.result);
            }
;
nempty_seplist_o__i__s__i__s_exp_p_ returns [MyList<expr> result]
: nempty_seplist_o__i__s__i__s_exp_p__0__1=exp { 
                $result = new MyList<expr> { _localctx.nempty_seplist_o__i__s__i__s_exp_p__0__1.result };
            }
| nempty_seplist_o__i__s__i__s_exp_p__1__1=nempty_seplist_o__i__s__i__s_exp_p_ ',' nempty_seplist_o__i__s__i__s_exp_p__1__3=exp { 
                $result = (MyList<expr>) appendList<expr>((MyList<expr>) _localctx.nempty_seplist_o__i__s__i__s_exp_p__1__1.result, (expr) _localctx.nempty_seplist_o__i__s__i__s_exp_p__1__3.result);
            }
;
...
| allow_empty_o_nempty_seplist_o__i__s__i__s_exp_p__p__1__1=nempty_seplist_o__i__s__i__s_exp_p_ { 
                $result = _localctx.allow_empty_o_nempty_seplist_o__i__s__i__s_exp_p__p__1__1.result;
            }
;
...
: seplist_o__i__s__i__s_exp_p__0__1=allow_empty_o_nempty_seplist_o__i__s__i__s_exp_p__p_ { 
                $result = _localctx.seplist_o__i__s__i__s_exp_p__0__1.result;
            }
;
...
: opt_o_funcname_p__0__1=funcname { 
                $result = (maybe<funcname>) some<funcname>((funcname) _localctx.opt_o_funcname_p__0__1.result);
            }
|  { 
...
: opt_o_parlist_p__0__1=parlist { 
                $result = (maybe<parameters>) some<parameters>((parameters) _localctx.opt_o_parlist_p__0__1.result);
            }
|  { 
...
: functiondef_0__1='function' functiondef_0__2=opt_o_funcname_p_ '(' functiondef_0__4=opt_o_parlist_p_ ')' functiondef_0__6=block 'end' { 
                $result = (expr) FuncDef((IToken) _localctx.functiondef_0__1, (bool) false, (maybe<funcname>) _localctx.functiondef_0__2.result, (maybe<parameters>) _localctx.functiondef_0__4.result, (block) _localctx.functiondef_0__6.result);
            }
;
...
: nempty_seplist_o__i__s__i__s__i_name_k__p__0__1=NAME { 
                $result = new MyList<IToken> { _localctx.nempty_seplist_o__i__s__i__s__i_name_k__p__0__1 };
            }
| nempty_seplist_o__i__s__i__s__i_name_k__p__1__1=nempty_seplist_o__i__s__i__s__i_name_k__p_ ',' nempty_seplist_o__i__s__i__s__i_name_k__p__1__3=NAME { 
                $result = (MyList<IToken>) appendList<IToken>((MyList<IToken>) _localctx.nempty_seplist_o__i__s__i__s__i_name_k__p__1__1.result, (IToken) _localctx.nempty_seplist_o__i__s__i__s__i_name_k__p__1__3);
            }
;
...
| parlist_1__1=nempty_seplist_o__i__s__i__s__i_name_k__p_ parlist_1__2=varargs { 
...
: nempty_seplist_o_fieldsep_s_field_p__0__1=field { 
                $result = new MyList<table_field> { _localctx.nempty_seplist_o_fieldsep_s_field_p__0__1.result };
            }
| nempty_seplist_o_fieldsep_s_field_p__1__1=nempty_seplist_o_fieldsep_s_field_p_ fieldsep nempty_seplist_o_fieldsep_s_field_p__1__3=field { 
...
: funcname_0__1=funcname '.' funcname_0__3=NAME { 
                $result = (funcname) DotName((funcname) _localctx.funcname_0__1.result, (IToken) _localctx.funcname_0__3);
            }
| funcname_1__1=funcname ':' funcname_1__3=NAME { 
                $result = (funcname) MethodName((funcname) _localctx.funcname_1__1.result, (IToken) _localctx.funcname_1__3);
            }
| funcname_2__1=NAME { 
                $result = (funcname) VarName((IToken) _localctx.funcname_2__1);
            }
;
