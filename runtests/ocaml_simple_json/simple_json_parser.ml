...
# 10 "runtests/ocaml_simple_json/simple_json_parser.mly"
      (tbnf_token)
# 200 "runtests/ocaml_simple_json/simple_json_parser.ml"
        )) * _menhir_state * 'tv_seplist_o__i__s__i__s_json_p_) = Obj.magic _menhir_stack in
        let (_menhir_stack, _menhir_s, _) = _menhir_stack in
...
# 5 "runtests/ocaml_simple_json/simple_json_parser.mly"
      (tbnf_token)
# 208 "runtests/ocaml_simple_json/simple_json_parser.ml"
) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    let _menhir_env = _menhir_discard _menhir_env in
...
# 5 "runtests/ocaml_simple_json/simple_json_parser.mly"
      (tbnf_token)
# 220 "runtests/ocaml_simple_json/simple_json_parser.ml"
...
# 5 "runtests/ocaml_simple_json/simple_json_parser.mly"
      (tbnf_token)
# 254 "runtests/ocaml_simple_json/simple_json_parser.ml"
        )) = Obj.magic _menhir_stack in
        let (_menhir_stack, _menhir_s, _) = _menhir_stack in
...
# 8 "runtests/ocaml_simple_json/simple_json_parser.mly"
      (tbnf_token)
# 267 "runtests/ocaml_simple_json/simple_json_parser.ml"
        )) = Obj.magic _menhir_stack in
...
# 285 "runtests/ocaml_simple_json/simple_json_parser.ml"
         in
...
# 302 "runtests/ocaml_simple_json/simple_json_parser.ml"
         in
...
# 9 "runtests/ocaml_simple_json/simple_json_parser.mly"
      (tbnf_token)
# 314 "runtests/ocaml_simple_json/simple_json_parser.ml"
        )) = Obj.magic _menhir_stack in
        let (_menhir_s : _menhir_state) = _menhir_s in
        let (_v : 'tv_json) = _v in
        ((let (_menhir_env : _menhir_env) = _menhir_env in
...
# 9 "runtests/ocaml_simple_json/simple_json_parser.mly"
      (tbnf_token)
# 326 "runtests/ocaml_simple_json/simple_json_parser.ml"
        )) = Obj.magic _menhir_stack in
        let (_ : _menhir_state) = _menhir_s in
        let ((_3 : 'tv_json) : 'tv_json) = _v in
...
# 5 "runtests/ocaml_simple_json/simple_json_parser.mly"
      (tbnf_token)
# 333 "runtests/ocaml_simple_json/simple_json_parser.ml"
        ))), _) = _menhir_stack in
        let _v : 'tv_jsonpair = 
...
# 340 "runtests/ocaml_simple_json/simple_json_parser.ml"
         in
        let (_menhir_env : _menhir_env) = _menhir_env in
...
# 8 "runtests/ocaml_simple_json/simple_json_parser.mly"
      (tbnf_token)
# 352 "runtests/ocaml_simple_json/simple_json_parser.ml"
            )) = Obj.magic _menhir_stack in
            let (_menhir_s : _menhir_state) = _menhir_s in
            let (_v : 'tv_jsonpair) = _v in
            ((let (_menhir_env : _menhir_env) = _menhir_env in
...
# 370 "runtests/ocaml_simple_json/simple_json_parser.ml"
             in
...
# 387 "runtests/ocaml_simple_json/simple_json_parser.ml"
             in
...
# 406 "runtests/ocaml_simple_json/simple_json_parser.ml"
         in
        let (_menhir_env : _menhir_env) = _menhir_env in
...
# 427 "runtests/ocaml_simple_json/simple_json_parser.ml"
            ) = 
# 19 "runtests/ocaml_simple_json/simple_json_parser.mly"
                      ( _1 )
# 431 "runtests/ocaml_simple_json/simple_json_parser.ml"
             in
            let (_menhir_env : _menhir_env) = _menhir_env in
...
# 16 "runtests/ocaml_simple_json/simple_json_parser.mly"
       (Simple_json_require.json)
# 459 "runtests/ocaml_simple_json/simple_json_parser.ml"
            )) = _v in
...
# 8 "runtests/ocaml_simple_json/simple_json_parser.mly"
      (tbnf_token)
# 480 "runtests/ocaml_simple_json/simple_json_parser.ml"
        )) = Obj.magic _menhir_stack in
...
# 9 "runtests/ocaml_simple_json/simple_json_parser.mly"
      (tbnf_token)
# 511 "runtests/ocaml_simple_json/simple_json_parser.ml"
        )) = Obj.magic _menhir_stack in
        let ((_menhir_stack, _menhir_s, _), _) = _menhir_stack in
...
# 5 "runtests/ocaml_simple_json/simple_json_parser.mly"
      (tbnf_token)
# 532 "runtests/ocaml_simple_json/simple_json_parser.ml"
) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_env = _menhir_discard _menhir_env in
    let (_menhir_env : _menhir_env) = _menhir_env in
...
# 5 "runtests/ocaml_simple_json/simple_json_parser.mly"
      (tbnf_token)
# 542 "runtests/ocaml_simple_json/simple_json_parser.ml"
    )) : (
# 5 "runtests/ocaml_simple_json/simple_json_parser.mly"
      (tbnf_token)
# 546 "runtests/ocaml_simple_json/simple_json_parser.ml"
    )) = _v in
    let _v : 'tv_json = 
...
# 553 "runtests/ocaml_simple_json/simple_json_parser.ml"
     in
...
# 13 "runtests/ocaml_simple_json/simple_json_parser.mly"
      (tbnf_token)
# 560 "runtests/ocaml_simple_json/simple_json_parser.ml"
) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    let _menhir_env = _menhir_discard _menhir_env in
...
# 13 "runtests/ocaml_simple_json/simple_json_parser.mly"
      (tbnf_token)
# 572 "runtests/ocaml_simple_json/simple_json_parser.ml"
        )) = Obj.magic _menhir_stack in
        let (_menhir_s : _menhir_state) = MenhirState2 in
        let (_v : (
# 14 "runtests/ocaml_simple_json/simple_json_parser.mly"
      (tbnf_token)
# 578 "runtests/ocaml_simple_json/simple_json_parser.ml"
        )) = _v in
        let _menhir_env = _menhir_discard _menhir_env in
        ((let (_menhir_env : _menhir_env) = _menhir_env in
...
# 13 "runtests/ocaml_simple_json/simple_json_parser.mly"
      (tbnf_token)
# 585 "runtests/ocaml_simple_json/simple_json_parser.ml"
        )) = Obj.magic _menhir_stack in
        let (_ : _menhir_state) = _menhir_s in
        let (_ : (
# 14 "runtests/ocaml_simple_json/simple_json_parser.mly"
      (tbnf_token)
# 591 "runtests/ocaml_simple_json/simple_json_parser.ml"
        )) = _v in
        let (_menhir_stack, _menhir_s, _) = _menhir_stack in
        let _v : 'tv_json = 
...
# 10 "runtests/ocaml_simple_json/simple_json_parser.mly"
      (tbnf_token)
# 612 "runtests/ocaml_simple_json/simple_json_parser.ml"
) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    let _menhir_env = _menhir_discard _menhir_env in
...
# 10 "runtests/ocaml_simple_json/simple_json_parser.mly"
      (tbnf_token)
# 632 "runtests/ocaml_simple_json/simple_json_parser.ml"
        )) = Obj.magic _menhir_stack in
        let (_menhir_s : _menhir_state) = MenhirState5 in
        let (_v : (
# 11 "runtests/ocaml_simple_json/simple_json_parser.mly"
      (tbnf_token)
# 638 "runtests/ocaml_simple_json/simple_json_parser.ml"
        )) = _v in
        let _menhir_env = _menhir_discard _menhir_env in
        ((let (_menhir_env : _menhir_env) = _menhir_env in
...
# 659 "runtests/ocaml_simple_json/simple_json_parser.ml"
         in
...
# 12 "runtests/ocaml_simple_json/simple_json_parser.mly"
      (tbnf_token)
# 674 "runtests/ocaml_simple_json/simple_json_parser.ml"
) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_env = _menhir_discard _menhir_env in
    let (_menhir_env : _menhir_env) = _menhir_env in
...
# 12 "runtests/ocaml_simple_json/simple_json_parser.mly"
      (tbnf_token)
# 684 "runtests/ocaml_simple_json/simple_json_parser.ml"
    )) = _v in
    let _v : 'tv_json = 
...
# 691 "runtests/ocaml_simple_json/simple_json_parser.ml"
     in
...
# 7 "runtests/ocaml_simple_json/simple_json_parser.mly"
      (tbnf_token)
# 698 "runtests/ocaml_simple_json/simple_json_parser.ml"
) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_env = _menhir_discard _menhir_env in
    let (_menhir_env : _menhir_env) = _menhir_env in
...
# 7 "runtests/ocaml_simple_json/simple_json_parser.mly"
      (tbnf_token)
# 708 "runtests/ocaml_simple_json/simple_json_parser.ml"
    )) : (
# 7 "runtests/ocaml_simple_json/simple_json_parser.mly"
      (tbnf_token)
# 712 "runtests/ocaml_simple_json/simple_json_parser.ml"
    )) = _v in
    let _v : 'tv_json = 
...
# 719 "runtests/ocaml_simple_json/simple_json_parser.ml"
     in
...
# 6 "runtests/ocaml_simple_json/simple_json_parser.mly"
      (tbnf_token)
# 726 "runtests/ocaml_simple_json/simple_json_parser.ml"
) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_env = _menhir_discard _menhir_env in
    let (_menhir_env : _menhir_env) = _menhir_env in
...
# 6 "runtests/ocaml_simple_json/simple_json_parser.mly"
      (tbnf_token)
# 736 "runtests/ocaml_simple_json/simple_json_parser.ml"
    )) : (
# 6 "runtests/ocaml_simple_json/simple_json_parser.mly"
      (tbnf_token)
# 740 "runtests/ocaml_simple_json/simple_json_parser.ml"
    )) = _v in
    let _v : 'tv_json = 
...
# 747 "runtests/ocaml_simple_json/simple_json_parser.ml"
     in
...
# 16 "runtests/ocaml_simple_json/simple_json_parser.mly"
       (Simple_json_require.json)
# 766 "runtests/ocaml_simple_json/simple_json_parser.ml"
) =
  fun lexer lexbuf ->
    let _menhir_env = {
      _menhir_lexer = lexer;
