...
export class TBNFLexer extends antlr.Lexer {
    ...
    public constructor(input: antlr.CharStream) {
        super(input);
        this.interpreter = new antlr.LexerATNSimulator(this, TBNFLexer._ATN, TBNFLexer.decisionsToDFA, new antlr.PredictionContextCache());
    }

    public get grammarFileName(): string { return "TBNF.g4"; }

    public get literalNames(): (string | null)[] { return TBNFLexer.literalNames; }
    public get symbolicNames(): (string | null)[] { return TBNFLexer.symbolicNames; }
    public get ruleNames(): string[] { return TBNFLexer.ruleNames; }

    public get serializedATN(): number[] { return TBNFLexer._serializedATN; }

    public get channelNames(): string[] { return TBNFLexer.channelNames; }

    public get modeNames(): string[] { return TBNFLexer.modeNames; }
    ...
    public static get _ATN(): antlr.ATN {
        if (!TBNFLexer.__ATN) {
            TBNFLexer.__ATN = new antlr.ATNDeserializer().deserialize(TBNFLexer._serializedATN);
        }

        return TBNFLexer.__ATN;
    }


    private static readonly vocabulary = new antlr.Vocabulary(TBNFLexer.literalNames, TBNFLexer.symbolicNames, []);

    public override get vocabulary(): antlr.Vocabulary {
        return TBNFLexer.vocabulary;
    }

    private static readonly decisionsToDFA = TBNFLexer._ATN.decisionToState.map( (ds: antlr.DecisionState, index: number) => new antlr.DFA(ds, index) );
}