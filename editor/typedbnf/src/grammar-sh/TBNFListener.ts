...
import { Slist_o__i__s__i__s_ignore_item_p_Context } from "./TBNFParser.js";
import { ToplevelContext } from "./TBNFParser.js";
import { Ignore_itemContext } from "./TBNFParser.js";
import { Macro_varContext } from "./TBNFParser.js";
import { Slist_o__i__s__i__s_macro_var_p_Context } from "./TBNFParser.js";
...
export class TBNFListener implements ParseTreeListener {
    ...
    /**
     * Enter a parse tree produced by `TBNFParser.slist_o__i__s__i__s_ignore_item_p_`.
     * @param ctx the parse tree
     */
    enterSlist_o__i__s__i__s_ignore_item_p_?: (ctx: Slist_o__i__s__i__s_ignore_item_p_Context) => void;
    /**
     * Exit a parse tree produced by `TBNFParser.slist_o__i__s__i__s_ignore_item_p_`.
     * @param ctx the parse tree
     */
    exitSlist_o__i__s__i__s_ignore_item_p_?: (ctx: Slist_o__i__s__i__s_ignore_item_p_Context) => void;
    /**
    ...
    /**
     * Enter a parse tree produced by `TBNFParser.ignore_item`.
     * @param ctx the parse tree
     */
    enterIgnore_item?: (ctx: Ignore_itemContext) => void;
    /**
     * Exit a parse tree produced by `TBNFParser.ignore_item`.
     * @param ctx the parse tree
     */
    exitIgnore_item?: (ctx: Ignore_itemContext) => void;
    /**
     * Enter a parse tree produced by `TBNFParser.macro_var`.
     * @param ctx the parse tree
     */
    enterMacro_var?: (ctx: Macro_varContext) => void;
    /**
     * Exit a parse tree produced by `TBNFParser.macro_var`.
     * @param ctx the parse tree
     */
    exitMacro_var?: (ctx: Macro_varContext) => void;
    /**
     * Enter a parse tree produced by `TBNFParser.slist_o__i__s__i__s_macro_var_p_`.
     * @param ctx the parse tree
     */
    enterSlist_o__i__s__i__s_macro_var_p_?: (ctx: Slist_o__i__s__i__s_macro_var_p_Context) => void;
    /**
     * Exit a parse tree produced by `TBNFParser.slist_o__i__s__i__s_macro_var_p_`.
     * @param ctx the parse tree
     */
    exitSlist_o__i__s__i__s_macro_var_p_?: (ctx: Slist_o__i__s__i__s_macro_var_p_Context) => void;
    /**
