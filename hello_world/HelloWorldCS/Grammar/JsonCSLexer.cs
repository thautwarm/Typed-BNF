...
public partial class JsonCSLexer : Lexer {
	...
	public JsonCSLexer(ICharStream input)
	: this(input, Console.Out, Console.Error) { }

	public JsonCSLexer(ICharStream input, TextWriter output, TextWriter errorOutput)
