/// TypeScript2Antlr uses tagged unions instead of case classes for ADT encoding.
module tbnf.Backends.TypescriptAntlrTaggedUnion
                    ...
                    vsep
                        [ yield word "import * as antlr from 'antlr4ng';"
                          ...
                          for (typename, cases) in adtCases do
                              ...
                              yield
                                  vsep
                                      [ word $"export type {typename'} ="
                                        vsep
                                            [ for name in union_names do
                                                  word "|" + word name ]
                                        >>> 4 ]
