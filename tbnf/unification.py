...
class Manager:
    def __init__(self) -> None:
        ...
        self.ty_env = Dictionary([], ObjectExpr3())
    

Manager_reflection = expr_4
...
def Manager__CellRepr_7A2426C3(__: Manager, cell: Cell_1[monot]) -> str:
    a : Any = FSharpRef("")
    def arrow_7(v: str, __=__, cell=cell) -> None:
        a.contents = v
    
    if try_get_value(__.ty_env, cell, FSharpRef(lambda __=__, cell=cell: a.contents, arrow_7)):
        return a.contents
        ...
        if pattern_matching_result == 0:
            ...
            if pattern_matching_result_1 == 0:
                ...
                if pattern_matching_result_2 == 0:
                    ...
                    def arrow_17(l_2: monot, r_2: monot, this=this, l=l, r=r) -> None:
                        Manager__unify(this, l_2, r_2)
                    
                    iterate2(arrow_17, xs_1, ys_1)
                    ...
                    if pattern_matching_result_3 == 0:
                        def arrow_18(l_3: monot, r_3: monot, this=this, l=l, r=r) -> None:
                            Manager__unify(this, l_3, r_3)
                        
                        iterate2(arrow_18, xs_3, ys_3)
                        this_mut = this
                        l_mut = x_3
                        r_mut = y_3
                        continue
...
def Manager__instantiate_Z25E5E15E(this: Manager, t: polyt) -> Tuple[FSharpList[monot], monot]:
    ...
    if pattern_matching_result == 0:
        ...
        replace_map : Any = of_list(specialization_args, ObjectExpr24())
