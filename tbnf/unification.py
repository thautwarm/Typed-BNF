...
from fable_modules.fable_library.util import (equals, safe_hash, compare_primitives)
from .exceptions import (IllFormedType, TypeMismatch, UnboundTypeVariable)
from .grammar import (Cell_1, monot, polyt, Cell_1__ctor, monot__find_any_children_z23d07ce9, monot__prune, Cell_1__Set_2B595, monot__transform_children_z2cab662a)
...
class Manager:
    def __init__(self) -> None:
        class ObjectExpr37:
            @property
            def Equals(self) -> Any:
                return lambda x, y: equals(x, y)
            
            @property
            def GetHashCode(self) -> Any:
                return lambda x: safe_hash(x)
            
        self.ty_env = Dictionary([], ObjectExpr37())
    

Manager_reflection = expr_38
...
def Manager__CellRepr_7A2426C3(__: Manager, cell: Cell_1[monot]) -> str:
    a : Any = FSharpRef("")
    def arrow_39(v: str, __=__, cell=cell) -> None:
        a.contents = v
    
    if try_get_value(__.ty_env, cell, FSharpRef(lambda __=__, cell=cell: a.contents, arrow_39)):
        return a.contents
...
def Manager__newTyRef_Z721C83C5(this: Manager, name: str) -> monot:
    cell : Cell_1[monot] = Cell_1__ctor()
    add_to_dict(this.ty_env, cell, name)
    return monot(0, cell)
...
def Manager__unify(this_mut: Manager, l_mut: monot, r_mut: monot) -> None:
    while True:
        ...
        if pattern_matching_result == 0:
            ...
            if Manager__occur_in(this, cell, r_1):
            ...
            if pattern_matching_result_1 == 0:
                ...
                if pattern_matching_result_2 == 0:
                    ...
                    def arrow_40(l_2: monot, r_2: monot, this=this, l=l, r=r) -> None:
                        Manager__unify(this, l_2, r_2)
                    
                    iterate2(arrow_40, xs_1, ys_1)
                    ...
                    if pattern_matching_result_3 == 0:
                        def arrow_41(l_3: monot, r_3: monot, this=this, l=l, r=r) -> None:
                            Manager__unify(this, l_3, r_3)
                        
                        iterate2(arrow_41, xs_3, ys_3)
                        this_mut = this
                        l_mut = x_3
                        r_mut = y_3
                        continue
...
def Manager__instantiate_Z25E5E15E(this: Manager, t: polyt) -> Tuple[FSharpList[monot], monot]:
    ...
    if pattern_matching_result == 0:
        ...
        replace_map : Any = of_list(specialization_args, ObjectExpr42())
