...
IdHelper_idEnv_reflection = expr_17
...
def IdHelper_newIdEnv() -> IdHelper_idEnv:
    ...
    return IdHelper_idEnv(empty(ObjectExpr21()))
...
NameMangling_nameEnv_reflection = expr_23
...
NameMangling_IdentifierDescriptor_reflection = expr_24
...
DocBuilder_block_1_reflection = expr_28
...
DocBuilder_Builder_reflection = expr_29
...
def DocBuilder_Builder__For_4C40856C(__: DocBuilder_Builder, m: Any, f: Callable[[t], DocBuilder_block_1[u]]) -> DocBuilder_block_1[FSharpList[u]]:
    ...
    def arrow_32(__=__, m=m, f=f) -> Any:
        def arrow_31(each: Any=None) -> Any:
            nonlocal suite
            m_0027 : DocBuilder_block_1[u] = f(each)
            suite = append(m_0027.suite, suite)
            return singleton_1(m_0027.value)
        
        return collect(arrow_31, m)
    
    value : FSharpList[u] = to_list(delay(arrow_32))
