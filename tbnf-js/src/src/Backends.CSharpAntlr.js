  ...
  return (0, _ErrorReport.withErrorHandler)((objectArg_1 = analyzer.Sigma, () => (0, _Analysis.Sigma__GetErrorTrace)(objectArg_1)), () => {
    ...
    if (matchValue_12 != null) {
      ...
      return [[langName + ".g4", (0, _CodeGen.vsep)((0, _Seq.toList)((0, _Seq.delay)(() => (0, _Seq.append)((0, _Seq.singleton)((0, _CodeGen.word)(`grammar ${langName};`)), (0, _Seq.delay)(() => (0, _Seq.append)((0, _Seq.singleton)((0, _CodeGen.word)("options { language = CSharp; }")), (0, _Seq.delay)(() => (0, _Seq.append)((0, _Seq.singleton)((0, _CodeGen.word)("@members {")), (0, _Seq.delay)(() => (0, _Seq.append)((0, _Seq.collect)(matchValue_14 => {
        const tparams_3 = matchValue_14[0];
        const ret_t_2 = matchValue_14[4];
        const fields_3 = matchValue_14[3];
        const ctor_name = matchValue_14[2];
        ...
        return (0, _Seq.singleton)((0, _CodeGen.vsep)((0, _Seq.toList)((0, _Seq.delay)(() => (0, _Seq.append)((0, _Seq.singleton)((0, _CodeGen.Doc_op_Addition_Z7CFFAC00)((0, _CodeGen.Doc_op_Addition_Z7CFFAC00)((0, _CodeGen.Doc_op_Addition_Z7CFFAC00)((0, _CodeGen.word)("public static"), ret_t_2), (0, _CodeGen.word)(matchValue_14[1])), (0, _CodeGen.Doc_op_Multiply_Z7CFFAC00)((0, _CodeGen.word)(tparams_3), func_params_2))), (0, _Seq.delay)(() => (0, _Seq.append)((0, _Seq.singleton)((0, _CodeGen.word)("{")), (0, _Seq.delay)(() => (0, _Seq.append)((0, _Seq.singleton)(tparams_3 === "" ? (0, _CodeGen.Doc_op_RightShift_2AAA0F3C)((0, _CodeGen.vsep)((0, _List.singleton)((0, _CodeGen.Doc_op_Addition_Z7CFFAC00)((0, _CodeGen.Doc_op_Addition_Z7CFFAC00)((0, _CodeGen.Doc_op_Addition_Z7CFFAC00)((0, _CodeGen.word)("return"), (0, _CodeGen.parens)(ret_t_2)), (0, _CodeGen.word)("new")), (0, _CodeGen.Doc_op_Multiply_Z7CFFAC00)((0, _CodeGen.Doc_op_Multiply_Z7CFFAC00)((0, _CodeGen.word)(ctor_name), args_10), (0, _CodeGen.word)(";"))))), 4) : (0, _CodeGen.Doc_op_RightShift_2AAA0F3C)((0, _CodeGen.vsep)((0, _List.singleton)((0, _CodeGen.Doc_op_Addition_Z7CFFAC00)((0, _CodeGen.Doc_op_Addition_Z7CFFAC00)((0, _CodeGen.Doc_op_Addition_Z7CFFAC00)((0, _CodeGen.word)("return"), (0, _CodeGen.parens)(ret_t_2)), (0, _CodeGen.word)("new")), (0, _CodeGen.Doc_op_Multiply_Z7CFFAC00)((0, _CodeGen.Doc_op_Multiply_Z7CFFAC00)((0, _CodeGen.Doc_op_Multiply_Z7CFFAC00)((0, _CodeGen.word)(ctor_name), (0, _CodeGen.word)(tparams_3)), args_10), (0, _CodeGen.word)(";"))))), 4)), (0, _Seq.delay)(() => (0, _Seq.singleton)((0, _CodeGen.word)("}"))))))))))));
