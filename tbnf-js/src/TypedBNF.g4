...
| list_o_toplevel_p__1__1=list_o_toplevel_p_ list_o_toplevel_p__1__2=toplevel { 
                $result = <Array<definition>> addList<definition>(<Array<definition>> _localctx._list_o_toplevel_p__1__1.result, <definition> _localctx._list_o_toplevel_p__1__2.result);
            }
;
...
| slist_o__i__s__i__s_param_type_p__1__1=slist_o__i__s__i__s_param_type_p_ ',' slist_o__i__s__i__s_param_type_p__1__3=param_type { 
                $result = <Array<[string, monot]>> addList<[string, monot]>(<Array<[string, monot]>> _localctx._slist_o__i__s__i__s_param_type_p__1__1.result, <[string, monot]> _localctx._slist_o__i__s__i__s_param_type_p__1__3.result);
            }
;
...
| '(' arrow_typ_1__2=eslist_o__i__s__i__s_param_type_p_ ')' '->' arrow_typ_1__5=arrow_typ { 
                $result = <monot> MK_TFun(<Array<[string, monot]>> <Array<[string, monot]>> process_tparam(<Array<[string, monot]>> _localctx._arrow_typ_1__2.result), <monot> _localctx._arrow_typ_1__5.result);
            }
| arrow_typ_2__1=type_product { 
                $result = <monot> MK_TTuple(<Array<monot>> _localctx._arrow_typ_2__1.result);
            }
;
...
| slist_o__i__s__i__s_typ_p__1__1=slist_o__i__s__i__s_typ_p_ ',' slist_o__i__s__i__s_typ_p__1__3=typ { 
                $result = <Array<monot>> addList<monot>(<Array<monot>> _localctx._slist_o__i__s__i__s_typ_p__1__1.result, <monot> _localctx._slist_o__i__s__i__s_typ_p__1__3.result);
            }
;
...
| type_product_1__1=typ2 { 
                $result = <Array<monot>>[ _localctx._type_product_1__1.result ];
            }
;
top_typ returns [polyt result]
: '<' top_typ_0__2=slist_o__i__s__i__s_tvar_str_p_ '>' top_typ_0__4=typ { 
                $result = <polyt> MK_Poly(<Array<string>> _localctx._top_typ_0__2.result, <monot> _localctx._top_typ_0__4.result);
            }
| top_typ_1__1=typ { 
...
: '\'' tvar_0__2=CNAMEPLUS { 
                $result = <monot> MK_TVar(<string> <string> str(<Token> _localctx._tvar_0__2));
            }
;
tvar_str returns [string result]
: '\'' tvar_str_0__2=CNAMEPLUS { 
                $result = <string> str(<Token> _localctx._tvar_str_0__2);
            }
;
...
| param_type_1__1=typ { 
                $result = <[string, monot]>["_", _localctx._param_type_1__1.result];
            }
;
...
| slist_o__i__s__i__s_tvar_str_p__1__1=slist_o__i__s__i__s_tvar_str_p_ ',' slist_o__i__s__i__s_tvar_str_p__1__3=tvar_str { 
                $result = <Array<string>> addList<string>(<Array<string>> _localctx._slist_o__i__s__i__s_tvar_str_p__1__1.result, <string> _localctx._slist_o__i__s__i__s_tvar_str_p__1__3.result);
            }
;
...
| slist_o__i__s__i__s_field_ann_p__1__1=slist_o__i__s__i__s_field_ann_p_ ',' slist_o__i__s__i__s_field_ann_p__1__3=field_ann { 
                $result = <Array<[string, monot, position]>> addList<[string, monot, position]>(<Array<[string, monot, position]>> _localctx._slist_o__i__s__i__s_field_ann_p__1__1.result, <[string, monot, position]> _localctx._slist_o__i__s__i__s_field_ann_p__1__3.result);
            }
;
...
| decl_1__1='case' decl_1__2=identstr ':' decl_1__4=typ { 
                $result = <definition> MK_Declctor(<string> _localctx._decl_1__2.result, <monot> _localctx._decl_1__4.result, <position> <position> mkpos(<Token> _localctx._decl_1__1));
            }
...
| toplevel_3__1='ignore' toplevel_3__2=slist_o__i__s__i__s_identstr_p_ { 
                $result = <definition> MK_Defignore(<Array<string>> _localctx._toplevel_3__2.result, <position> <position> mkpos(<Token> _localctx._toplevel_3__1));
            }
;
...
| slist_o__i__s__i__s_identstr_p__1__1=slist_o__i__s__i__s_identstr_p_ ',' slist_o__i__s__i__s_identstr_p__1__3=identstr { 
                $result = <Array<string>> addList<string>(<Array<string>> _localctx._slist_o__i__s__i__s_identstr_p__1__1.result, <string> _localctx._slist_o__i__s__i__s_identstr_p__1__3.result);
            }
;
...
| def_1__1=CNAMEPLUS def_1__2=productions { 
                $result = <definition> MK_Defrule(<string> <string> str(<Token> _localctx._def_1__1), <Array<[position, production]>> _localctx._def_1__2.result, <position> <position> mkpos(<Token> _localctx._def_1__1));
            }
;
...
| productions_1__1=productions productions_1__2='|' productions_1__3=production { 
                $result = <Array<[position, production]>> addList<[position, production]>(<Array<[position, production]>> _localctx._productions_1__1.result, <[position, production]> <[position, production]>[<position> mkpos(<Token> _localctx._productions_1__2), _localctx._productions_1__3.result]);
            }
;
...
| list_o_psym_p__1__1=list_o_psym_p_ list_o_psym_p__1__2=psym { 
                $result = <Array<symbol>> addList<symbol>(<Array<symbol>> _localctx._list_o_psym_p__1__1.result, <symbol> _localctx._list_o_psym_p__1__2.result);
            }
;
...
| slist_o__i__s__i__s_psym_p__1__1=slist_o__i__s__i__s_psym_p_ ',' slist_o__i__s__i__s_psym_p__1__3=psym { 
                $result = <Array<symbol>> addList<symbol>(<Array<symbol>> _localctx._slist_o__i__s__i__s_psym_p__1__1.result, <symbol> _localctx._slist_o__i__s__i__s_psym_p__1__3.result);
            }
;
...
| psym_1__1=ESCAPED_STRING { 
                $result = <symbol> MK_Term(<string> <string> unescape(<string> <string> str(<Token> _localctx._psym_1__1)), <boolean> true);
            }
| psym_2__1=identstr { 
                $result = <symbol> MK_Nonterm(<string> _localctx._psym_2__1.result);
            }
| psym_3__1=CNAMEPLUS '(' psym_3__3=slist_o__i__s__i__s_psym_p_ ')' { 
                $result = <symbol> MK_Macrocall(<string> <string> str(<Token> _localctx._psym_3__1), <Array<symbol>> _localctx._psym_3__3.result, <position> <position> mkpos(<Token> _localctx._psym_3__1));
            }
;
...
| slist_o__i__s__i__s_ann_p__1__1=slist_o__i__s__i__s_ann_p_ ',' slist_o__i__s__i__s_ann_p__1__3=ann { 
                $result = <Array<[string, monot]>> addList<[string, monot]>(<Array<[string, monot]>> _localctx._slist_o__i__s__i__s_ann_p__1__1.result, <[string, monot]> _localctx._slist_o__i__s__i__s_ann_p__1__3.result);
            }
;
...
| expr_1__1='fun' expr_1__2=func_parameters '->' expr_1__4=expr { 
                $result = <expr> MK_Expr(<node> <node> MK_EFun(<Array<[string, monot]>> _localctx._expr_1__2.result, <expr> _localctx._expr_1__4.result), <position> <position> mkpos(<Token> _localctx._expr_1__1));
            }
| expr_2__1=call { 
                $result = _localctx._expr_2__1.result;
            }
| expr_3__1=call ';' expr_3__3=expr { 
                $result = <expr> MK_Expr(<node> <node> MK_ELet(<string> "_", <expr> _localctx._expr_3__1.result, <expr> _localctx._expr_3__3.result), <position> <position> getpos(<expr> _localctx._expr_3__1.result));
            }
;
...
| slist_o__i__s__i__s_expr_p__1__1=slist_o__i__s__i__s_expr_p_ ',' slist_o__i__s__i__s_expr_p__1__3=expr { 
                $result = <Array<expr>> addList<expr>(<Array<expr>> _localctx._slist_o__i__s__i__s_expr_p__1__1.result, <expr> _localctx._slist_o__i__s__i__s_expr_p__1__3.result);
            }
;
...
| atomexp_1__1=FLOAT { 
                $result = <expr> MK_Expr(<node> <node> MK_EFlt(<number> <number> tofloat(<Token> _localctx._atomexp_1__1)), <position> <position> mkpos(<Token> _localctx._atomexp_1__1));
            }
| atomexp_2__1=ESCAPED_STRING { 
                $result = <expr> MK_Expr(<node> <node> MK_EStr(<string> <string> unescape(<string> <string> str(<Token> _localctx._atomexp_2__1))), <position> <position> mkpos(<Token> _localctx._atomexp_2__1));
            }
| atomexp_3__1='$' atomexp_3__2=INT { 
                $result = <expr> MK_Expr(<node> <node> MK_ESlot(<number> <number> toint(<Token> _localctx._atomexp_3__2)), <position> <position> mkpos(<Token> _localctx._atomexp_3__1));
            }
| atomexp_4__1='[' atomexp_4__2=eslist_o__i__s__i__s_expr_p_ ']' { 
                $result = <expr> MK_Expr(<node> <node> MK_EList(<Array<expr>> _localctx._atomexp_4__2.result), <position> <position> mkpos(<Token> _localctx._atomexp_4__1));
            }
| atomexp_5__1='(' ')' { 
                $result = <expr> MK_Expr(<node> <node> MK_ETuple(<Array<expr>> <Array<expr>>[  ]), <position> <position> mkpos(<Token> _localctx._atomexp_5__1));
            }
| atomexp_6__1='(' atomexp_6__2=slist_o__i__s__i__s_expr_p_ ')' { 
                $result = <expr> MK_Expr(<node> <node> MK_ETuple(<Array<expr>> _localctx._atomexp_6__2.result), <position> <position> mkpos(<Token> _localctx._atomexp_6__1));
            }
| atomexp_7__1=CNAMEPLUS { 
                $result = <expr> MK_Expr(<node> <node> MK_EVar(<string> <string> str(<Token> _localctx._atomexp_7__1)), <position> <position> mkpos(<Token> _localctx._atomexp_7__1));
            }
| atomexp_8__1=atomexp '.' atomexp_8__3=CNAMEPLUS { 
                $result = <expr> MK_Expr(<node> <node> MK_EField(<expr> _localctx._atomexp_8__1.result, <string> <string> str(<Token> _localctx._atomexp_8__3)), <position> <position> getpos(<expr> _localctx._atomexp_8__1.result));
            }
| atomexp_9__1='true' { 
                $result = <expr> MK_Expr(<node> <node> MK_EBool(<boolean> true), <position> <position> mkpos(<Token> _localctx._atomexp_9__1));
            }
| atomexp_10__1='false' { 
                $result = <expr> MK_Expr(<node> <node> MK_EBool(<boolean> false), <position> <position> mkpos(<Token> _localctx._atomexp_10__1));
            }
;
...
| slist_o__i__u__i__s_lexer_and_p__1__1=slist_o__i__u__i__s_lexer_and_p_ '|' slist_o__i__u__i__s_lexer_and_p__1__3=lexer_and { 
                $result = <Array<lexerule>> addList<lexerule>(<Array<lexerule>> _localctx._slist_o__i__u__i__s_lexer_and_p__1__1.result, <lexerule> _localctx._slist_o__i__u__i__s_lexer_and_p__1__3.result);
            }
;
...
| list_o_lexer_atomexpr_p__1__1=list_o_lexer_atomexpr_p_ list_o_lexer_atomexpr_p__1__2=lexer_atomexpr { 
                $result = <Array<lexerule>> addList<lexerule>(<Array<lexerule>> _localctx._list_o_lexer_atomexpr_p__1__1.result, <lexerule> _localctx._list_o_lexer_atomexpr_p__1__2.result);
            }
;
...
| lexer_atom_4__1=RANGE { 
                $result = <lexerule> getrange(<string> <string> str(<Token> _localctx._lexer_atom_4__1));
            }
| lexer_atom_5__1=UNICODE_RANGE { 
                $result = <lexerule> getunicoderange(<string> <string> str(<Token> _localctx._lexer_atom_5__1));
            }
| '_' { 
                $result = MK_LWildcard;
            }
...
| lexer_atom_8__1=CNAMEPLUS { 
                $result = <lexerule> MK_LRef(<string> <string> str(<Token> _localctx._lexer_atom_8__1));
            }
;
