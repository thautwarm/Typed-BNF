...
DocPrimitive_reflection = expr_17
...
def show_doc(doc: Doc) -> str:
    ...
    def arrow_46(x: str, doc: Doc=doc) -> None:
        ignore(StringBuilder__Append_Z721C83C5(sb, x))
    
    render(compile_to_prims(doc), arrow_46)
    return to_string(sb)
