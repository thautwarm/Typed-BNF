...
def codegen(analyzer: Analyzer, cg_options: CodeGenOptions, lang_name: str, stmts: List[definition_1]) -> List[Tuple[str, Doc]]:
    ...
    export_names : Any = of_array([export_parser, export_grammar], ObjectExpr188())
    ...
    abandoned_names : Any = of_array([export_tokenmaps, export_tokenreprs, "False", "None", "True", "and", "as", "assert", "async", "await", "break", "class", "continue", "def", "del", "elif", "else", "except", "finally", "for", "from", "global", "if", "import", "in", "is", "lambda", "nonlocal", "not", "or", "pass", "raise", "return", "try", "while", "with", "yield", "match", "case"], ObjectExpr189())
    class ObjectExpr190:
        @property
        def Compare(self) -> Any:
            return lambda x_6, y_2: compare(x_6, y_2)
        
    symmap : Any = empty_1(ObjectExpr190())
    ...
    lexer_maps : Any = empty_1(ObjectExpr191())
    ...
    def arrow_199(i: int, c: str, analyzer: Analyzer=analyzer, cg_options: CodeGenOptions=cg_options, lang_name: str=lang_name, stmts: List[definition_1]=stmts) -> bool:
    ...
    python_identifier_descr : NameMangling_IdentifierDescriptor = NameMangling_IdentifierDescriptor__WithNameEnv_Z7613F24B(NameMangling_IdentifierDescriptor_Create_Z48C5CCEF(arrow_199, lambda i_1, c_1, analyzer=analyzer, cg_options=cg_options, lang_name=lang_name, stmts=stmts: to_text(interpolate("_%P()_", [(i_1 * ord(c_1)) + 7])) if (is_digit(c_1)) else (to_text(interpolate("_%P()_", [ord(c_1)])))), NameMangling_nameEnv(of_list(map_1(lambda tuple, analyzer=analyzer, cg_options=cg_options, lang_name=lang_name, stmts=stmts: tuple[1], global_scope), ObjectExpr195())))
    class ObjectExpr203:
        @property
        def Compare(self) -> Any:
            return lambda x_9, y_5: compare_primitives(x_9, y_5)
        
    lark_lexer_identifier_descr : NameMangling_IdentifierDescriptor = NameMangling_IdentifierDescriptor__WithNameEnv_Z7613F24B(NameMangling_IdentifierDescriptor_Create_Z48C5CCEF(lambda i_2, c_2, analyzer=analyzer, cg_options=cg_options, lang_name=lang_name, stmts=stmts: is_upper(c_2) if (i_2 == 0) else (True if (True if (is_upper(c_2)) else (c_2 == "_")) else (is_digit(c_2))), lambda _arg1, c_3, analyzer=analyzer, cg_options=cg_options, lang_name=lang_name, stmts=stmts: c_3.upper() if (is_lower(c_3)) else (("_" + NameMangling_maskChar(ord("A"), ord("Z"), ord(c_3))) + "_")), NameMangling_nameEnv(of_array(["UNKNOWN"], ObjectExpr203())))
    class ObjectExpr206:
        @property
        def Compare(self) -> Any:
    ...
    def cg_expr(action_name: str, scope: FSharpList[Tuple[str, str]], expr: expr_1, analyzer: Analyzer=analyzer, cg_options: CodeGenOptions=cg_options, lang_name: str=lang_name, stmts: List[definition_1]=stmts) -> DocBuilder_block_1[Doc]:
        def arrow_230(action_name: str=action_name, scope: FSharpList[Tuple[str, str]]=scope, expr: expr_1=expr) -> DocBuilder_block_1[Doc]:
            match_value_1 : node = expr.node
            if match_value_1.tag == 6:
                match_value_2 : Optional[str] = List_tryLookup(match_value_1.fields[0], scope)
                def arrow_214(_unit=None) -> Doc:
                    raise UnboundVariable(match_value_1.fields[0])
                
                return DocBuilder_Builder__Return_1505(DocBuilder_cg, word(match_value_2)) if (match_value_2 is not None) else (DocBuilder_Builder__Return_1505(DocBuilder_cg, arrow_214()))
                ...
                def arrow_219(_arg6: Doc) -> DocBuilder_block_1[Doc]:
                ...
                def arrow_220(_unit=None) -> str:
                    arg20_1 : int = (match_value_1.fields[0] - 1) or 0
                    return to_text(printf("%s[%d]"))(TREE_NAME)(arg20_1)
                
                def arrow_225(_arg10: FSharpList[Doc]) -> DocBuilder_block_1[Doc]:
    ...
    def cg_stmt(stmt: definition_1, analyzer: Analyzer=analyzer, cg_options: CodeGenOptions=cg_options, lang_name: str=lang_name, stmts: List[definition_1]=stmts) -> Doc:
        ...
        if stmt.tag == 2:
            ...
            idx_1 : int = 0
            def arrow_233(stmt: definition_1=stmt) -> Iterable[Doc]:
                def arrow_232(match_value_3: Tuple[position, production_1]) -> Iterable[Doc]:
                    ...
                    def arrow_231(_unit=None) -> Iterable[Doc]:
                    ...
                    return append_1(singleton(Doc_op_Addition_Z7CFFAC00(Doc_op_Addition_Z7CFFAC00(seplist(word(" "), map_1(lambda arg_2: word(cg_symbol(arg_2)), production.symbols)), word("-\u003e")), word(action_name_2))), delay(arrow_231))
                
                return collect(arrow_232, decl["define"])
            
            body_4 : Doc = align(vsep(map_indexed(lambda i_6, e_1, stmt=stmt: Doc_op_Addition_Z7CFFAC00(word(":") if (i_6 == 0) else (word("|")), e_1), to_list(delay(arrow_233)))))
    ...
    def arrow_252(analyzer: Analyzer=analyzer, cg_options: CodeGenOptions=cg_options, lang_name: str=lang_name, stmts: List[definition_1]=stmts) -> Iterable[Doc]:
        def arrow_251(_unit=None) -> Iterable[Doc]:
            def arrow_250(_unit=None) -> Iterable[Doc]:
                def arrow_249(_unit=None) -> Iterable[Doc]:
                    def arrow_248(_unit=None) -> Iterable[Doc]:
                        adt_cases : FSharpList[Tuple[str, Any]] = Sigma__GetADTCases(analyzer.Sigma)
                        def arrow_247(_unit=None) -> Iterable[Doc]:
                            def arrow_246(_unit=None) -> Iterable[Doc]:
                                def arrow_239(match_value_5: Tuple[str, Any]) -> Iterable[Doc]:
                                    typename_0027 : str = rename_type(match_value_5[0])
                                    doc_ctor_names : FSharpList[Doc] = empty()
                                    def arrow_234(match_value_6: Tuple[str, FSharpList[Tuple[str, monot]]]) -> Iterable[Doc]:
                                    ...
                                    def arrow_238(_unit=None) -> Iterable[Doc]:
                                        def arrow_237(_unit=None) -> Iterable[Doc]:
                                            def arrow_236(_unit=None) -> Iterable[Doc]:
                                                def arrow_235(_unit=None) -> Iterable[Doc]:
                                                ...
                                                return arrow_235() if (is_empty(tail(doc_ctor_names))) else (singleton(Doc_op_Addition_Z7CFFAC00(Doc_op_Addition_Z7CFFAC00(word(typename_0027), word("=")), Doc_op_Multiply_Z7CFFAC00(Doc_op_Multiply_Z7CFFAC00(word(to_text(interpolate("%P().Union[", [modulevar_typing]))), seplist(word(","), doc_ctor_names)), word("]"))))) if (not is_empty(doc_ctor_names)) else (singleton(Doc_op_Addition_Z7CFFAC00(Doc_op_Addition_Z7CFFAC00(word(typename_0027), word("=")), Doc_op_Multiply_Z7CFFAC00(Doc_op_Multiply_Z7CFFAC00(word(to_text(interpolate("%P().Union[", [modulevar_typing]))), seplist(word(","), doc_ctor_names)), word("]")))))
                                            
                                            return append_1(singleton(Doc_op_RightShift_2AAA0F3C(vsep(to_list(delay(arrow_236))), 4)), delay(lambda _unit=None: append_1(singleton(word("else:")), delay(lambda _unit=None: append_1(singleton(Doc_op_RightShift_2AAA0F3C(vsep(singleton_1(Doc_op_Addition_Z7CFFAC00(Doc_op_Addition_Z7CFFAC00(word(typename_0027), word("=")), parens(seplist(word(","), doc_ctor_names))))), 4)), delay(lambda _unit=None: singleton(empty_2)))))))
                                        
                                        return append_1(singleton(word(to_text(interpolate("if %P().TYPE_CHECKING:", [modulevar_typing])))), delay(arrow_237))
                                    
                                    return append_1(collect(arrow_234, to_array_1(match_value_5[1])), delay(arrow_238))
                                
                                def arrow_245(_unit=None) -> Iterable[Doc]:
                                    def arrow_244(match_value_8: Tuple[str, Shape]) -> Iterable[Doc]:
                                        ...
                                        def arrow_243(_unit=None) -> Iterable[Doc]:
                                            def arrow_242(_unit=None) -> Iterable[Doc]:
                                                def arrow_241(_unit=None) -> Iterable[Doc]:
                                                    def arrow_240(match_value_9: Tuple[str, monot]) -> Iterable[Doc]:
                                                    ...
                                                    return collect(arrow_240, shape.fields)
                                                
                                                return append_1(singleton(Doc_op_RightShift_2AAA0F3C(word("pass"), 4)) if (is_empty(shape.fields)) else (singleton(Doc_op_RightShift_2AAA0F3C(vsep(to_list(delay(arrow_241))), 4))), delay(lambda _unit=None: append_1(singleton(empty_2), delay(lambda _unit=None: append_1(singleton(Doc_op_Addition_Z7CFFAC00(Doc_op_Addition_Z7CFFAC00(word(varname), word("=")), word(typename_0027_1))), delay(lambda _unit=None: singleton(empty_2)))))))
                                            
                                            return append_1(singleton(word(to_text(interpolate("class %P():", [typename_0027_1])))), delay(arrow_242))
                                        
                                        return append_1(singleton(word(to_text(interpolate("@%P().dataclass", [modulevar_dataclass])))), delay(arrow_243))
                                    
                                    return collect(arrow_244, Sigma__GetRecordTypes(analyzer.Sigma))
                                
                                return append_1(collect(arrow_239, adt_cases), delay(arrow_245))
                            
                            return append_1(singleton(empty_2), delay(arrow_246))
                        
                        return append_1(singleton(Doc_op_Addition_Z7CFFAC00(word(to_text(interpolate("from .%P() import", [filename_require]))), import_items)) if (not is_empty(import_names)) else (empty_3()), delay(arrow_247))
                    
                    return append_1(singleton(word(to_text(interpolate("import typing as %P()", [modulevar_typing])))), delay(arrow_248))
                
                return append_1(singleton(word(to_text(interpolate("import dataclasses as %P()", [modulevar_dataclass])))), delay(arrow_249))
            
            return append_1(singleton(word(to_text(interpolate("from lark import Token as %P()", [classvar_lark_token])))), delay(arrow_250))
        
        return append_1(singleton(word("from __future__ import annotations as __01asda1ha")), delay(arrow_251))
    
    file_constructors : Tuple[str, Doc] = (filename_constructors + ".py", vsep(to_list(delay(arrow_252))))
    ...
    sort_in_place_by(lambda k_2, analyzer=analyzer, cg_options=cg_options, lang_name=lang_name, stmts=stmts: find_index(lambda y_7: k_2 == y_7, analyzer.TokenFragments), ReferencedNamedTokens, ObjectExpr253())
    class ObjectExpr254:
        @property
        def Compare(self) -> Any:
            return lambda x_19, y_9: compare_primitives(x_19, y_9)
        
    arr : List[str] = sort(list(analyzer.LiteralTokens), ObjectExpr254())
