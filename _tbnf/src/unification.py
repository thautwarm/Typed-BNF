        ...
        if pattern_matching_result == 0:
            ...
            if pattern_matching_result_1 == 0:
                ...
                if pattern_matching_result_2 == 0:
                    ...
                    def arrow_18(l_2: monot, r_2: monot, this: Manager=this, l: monot=l, r: monot=r) -> None:
                        Manager__unify(this, l_2, r_2)
                    
                    iterate2(arrow_18, xs_1, ys_1)
                    ...
                    if pattern_matching_result_3 == 0:
                        def arrow_20(tupled_arg: Tuple[str, monot], tupled_arg_1: Tuple[str, monot], this: Manager=this, l: monot=l, r: monot=r) -> None:
                            Manager__unify(this, tupled_arg[1], tupled_arg_1[1])
                        
                        iterate2(arrow_20, xs_3, ys_3)
                        this_mut = this
                        l_mut = x_3
                        r_mut = y_3
                        continue
...
def Manager__instantiate_Z25E5E15E(this: Manager, t: polyt) -> Tuple[FSharpList[monot], monot]:
    ...
    if pattern_matching_result == 0:
        ...
        replace_map : Any = of_list(specialization_args, ObjectExpr25())
