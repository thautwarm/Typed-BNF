...
def codegen(analyzer: Analyzer, cg_options: CodeGenOptions, lang_name: str, stmts: List[definition]) -> List[Tuple[str, Doc]]:
    ...
    def arrow_131(analyzer: Analyzer=analyzer, cg_options: CodeGenOptions=cg_options, lang_name: str=lang_name, stmts: List[definition]=stmts) -> Iterable[Doc]:
        def arrow_130(_unit=None) -> Iterable[Doc]:
            def arrow_129(_unit=None) -> Iterable[Doc]:
                def arrow_128(_unit=None) -> Iterable[Doc]:
                    adt_cases : FSharpList[Tuple[str, Any]] = Sigma__GetADTCases(analyzer.Sigma)
                    def arrow_127(_unit=None) -> Iterable[Doc]:
                        def arrow_126(_unit=None) -> Iterable[Doc]:
                            def arrow_122(match_value_6: Tuple[str, Any]) -> Iterable[Doc]:
                                typename_0027 : str = type_renamer(match_value_6[0])
                                def arrow_121(_unit=None) -> Iterable[Doc]:
                                    def arrow_120(match_value_7: Tuple[str, FSharpList[Tuple[str, monot]]]) -> Iterable[Doc]:
                                        ...
                                        def arrow_119(_unit=None) -> Iterable[Doc]:
                                        ...
                                        return append_2(singleton_1(Doc_op_Addition_Z7CFFAC00(Doc_op_Multiply_Z7CFFAC00(word(to_text(interpolate("public partial record %P()", [ctor_name_0027]))), func_params), word(to_text(interpolate(": %P();", [typename_0027]))))), delay(arrow_119))
                                    
                                    return append_2(collect(arrow_120, to_array_1(match_value_6[1])), delay(lambda _unit=None: singleton_1(empty_2)))
                                
                                return append_2(singleton_1(word(to_text(interpolate("public partial interface %P() {  }", [typename_0027])))), delay(arrow_121))
                            
                            def arrow_125(_unit=None) -> Iterable[Doc]:
                                def arrow_124(match_value_9: Tuple[str, Shape]) -> Iterable[Doc]:
                                    ...
                                    def arrow_123(_unit=None) -> Iterable[Doc]:
                                        nonlocal doc_ctor_wrap_funcs
                                        doc_ctor_wrap_funcs = cons((tparams_2, varname, typename_0027_1, fields_2, pattern_input_2[1]), doc_ctor_wrap_funcs)
                                        return empty_3()
                                    
                                    return append_2(singleton_1(Doc_op_Multiply_Z7CFFAC00(Doc_op_Multiply_Z7CFFAC00(Doc_op_Multiply_Z7CFFAC00(word(to_text(interpolate("public partial record %P()", [typename_0027_1]))), word(tparams_2)), func_params_1), word(";"))), delay(arrow_123))
                                
                                return append_2(collect(arrow_124, Sigma__GetRecordTypes(analyzer.Sigma)), delay(lambda _unit=None: singleton_1(word("}"))))
                            
                            return append_2(collect(arrow_122, adt_cases), delay(arrow_125))
                        
                        return append_2(singleton_1(word(to_text(interpolate("namespace %P(){", [lang_name])))), delay(arrow_126))
                    
                    return append_2(singleton_1(empty_2), delay(arrow_127))
                
                return append_2(singleton_1(word("using System;")), delay(arrow_128))
            
            return append_2(singleton_1(word("using System.Collections.Generic;")), delay(arrow_129))
        
        return append_2(singleton_1(word("using Antlr4.Runtime;")), delay(arrow_130))
    
    file_constructors : Tuple[str, Doc] = (to_text(interpolate("%P().Constructor.", [lang_name])) + ".cs", vsep(to_list(delay(arrow_131))))
    ...
    if match_value_12 is not None:
        ...
        def cg_stmt(stmt: definition, analyzer: Analyzer=analyzer, cg_options: CodeGenOptions=cg_options, lang_name: str=lang_name, stmts: List[definition]=stmts) -> Doc:
            ...
            if stmt.tag == 2:
                ...
                idx_1 : int = 0
                def arrow_147(stmt: definition=stmt) -> Iterable[Doc]:
                    def arrow_146(match_value_4: Tuple[position, production_1]) -> Iterable[Doc]:
                        ...
                        def arrow_144(_unit=None) -> Doc:
                            ...
                            used_slots : Any = empty_4(ObjectExpr132())
                            def cg_expr(scope_1: FSharpList[Tuple[str, str]], curr_expr_1: expr) -> DocBuilder_block_1[Doc]:
                                def arrow_142(scope_1: FSharpList[Tuple[str, str]]=scope_1, curr_expr_1: expr=curr_expr_1) -> DocBuilder_block_1[Doc]:
                                    nonlocal used_slots
                                    ...
                                    if match_value_1.tag == 6:
                                        ...
                                        if match_value_2 is not None:
                                            ...
                                            return DocBuilder_Builder__Return_1505(DocBuilder_cg, word(v_1) if (length(match_value_1.fields[1].contents) == 0) else (arrow_133()))
                                        
                                        else: 
                                            def arrow_134(_unit=None) -> Doc:
                                                raise UnboundVariable(match_value_1.fields[0])
                                            
                                            return DocBuilder_Builder__Return_1505(DocBuilder_cg, arrow_134())
                                        ...
                                        def arrow_141(_arg2_1: Doc) -> DocBuilder_block_1[Doc]:
                                            def arrow_140(_unit=None) -> DocBuilder_block_1[FSharpList[Doc]]:
                                                def arrow_139(_arg3: expr) -> DocBuilder_block_1[Doc]:
                                                    arg : expr = _arg3
                                                ...
                                                return DocBuilder_Builder__For_2B96F4AF(DocBuilder_cg, match_value_1.fields[1], arrow_139)
                                            
                                            return DocBuilder_Builder__Bind_30A200B3(DocBuilder_cg, DocBuilder_Builder__Run_ZD0BB270(DocBuilder_cg, DocBuilder_Builder__Delay_Z3A9C5A06(DocBuilder_cg, arrow_140)), lambda _arg5: DocBuilder_Builder__Return_1505(DocBuilder_cg, Doc_op_Addition_Z7CFFAC00(word(to_text(interpolate("(%P())", [cg_type(curr_expr_1.t)]))), Doc_op_Multiply_Z7CFFAC00(_arg2_1, parens(seplist(word(", "), _arg5))))))
                                        
                                        return DocBuilder_Builder__Bind_30A200B3(DocBuilder_cg, DocBuilder_Builder__Run_ZD0BB270(DocBuilder_cg, DocBuilder_Builder__Delay_Z3A9C5A06(DocBuilder_cg, lambda _unit=None: DocBuilder_Builder__For_2B96F4AF(DocBuilder_cg, match_value_1.fields[0], lambda _arg10: DocBuilder_Builder__ReturnFrom_ZD0BB270(DocBuilder_cg, cg_expr(scope_1, _arg10))))), lambda _arg11: DocBuilder_Builder__Return_1505(DocBuilder_cg, parens(seplist(word(", "), _arg11)))) if (match_value_1.tag == 1) else (DocBuilder_Builder__Bind_30A200B3(DocBuilder_cg, cg_expr(scope_1, match_value_1.fields[0]), arrow_141))
                                    
                                
                                return DocBuilder_Builder__Run_ZD0BB270(DocBuilder_cg, DocBuilder_Builder__Delay_Z3A9C5A06(DocBuilder_cg, arrow_142))
                        ...
                        return append_2(singleton_1(arrow_144()), delay(arrow_145))
                    
                    return collect(arrow_146, decl["define"])
                
                body_3 : Doc = align(vsep(map_indexed(lambda i_10, e_1, stmt=stmt: Doc_op_Addition_Z7CFFAC00(word(":") if (i_10 == 0) else (word("|")), e_1), to_list(delay(arrow_147)))))
        ...
        def arrow_149(analyzer: Analyzer=analyzer, cg_options: CodeGenOptions=cg_options, lang_name: str=lang_name, stmts: List[definition]=stmts) -> Iterable[Doc]:
            def arrow_148(match_value_13: Tuple[str, lexerule]) -> Iterable[Doc]:
            ...
            return collect(arrow_148, reverse(lexer_maps))
        
        lexer_defs : FSharpList[Doc] = to_list(delay(arrow_149))
        start_mangled : str = cg_symbol(symbol(1, "start"))
        def arrow_157(analyzer: Analyzer=analyzer, cg_options: CodeGenOptions=cg_options, lang_name: str=lang_name, stmts: List[definition]=stmts) -> Iterable[Doc]:
            def arrow_156(_unit=None) -> Iterable[Doc]:
                def arrow_155(_unit=None) -> Iterable[Doc]:
                    def arrow_154(_unit=None) -> Iterable[Doc]:
                        def arrow_150(match_value_14: Tuple[str, str, str, FSharpList[Tuple[Doc, Doc]], Doc]) -> Iterable[Doc]:
                        ...
                        def arrow_153(_unit=None) -> Iterable[Doc]:
                            ...
                            return append_2(singleton_1(word("}")), delay(arrow_152))
                        
                        return append_2(collect(arrow_150, doc_ctor_wrap_funcs), delay(arrow_153))
                    
                    return append_2(singleton_1(word("@members {")), delay(arrow_154))
        ...
        return [(lang_name + ".g4", vsep(to_list(delay(arrow_157)))), file_constructors]
