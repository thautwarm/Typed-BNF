...
def codegen(analyzer: Analyzer, cg_options: CodeGenOptions, lang_name: str, stmts: List[definition]) -> List[Tuple[str, Doc]]:
    ...
    abandoned_names : Any = of_array(append(["result"], CSharpKeywords, None), ObjectExpr123())
    class ObjectExpr124:
        @property
        def Compare(self) -> Any:
            return lambda x_7, y_1: compare(x_7, y_1)
        
    symmap : Any = empty_1(ObjectExpr124())
    ...
    def arrow_126(i: int, c: str, analyzer: Analyzer=analyzer, cg_options: CodeGenOptions=cg_options, lang_name: str=lang_name, stmts: List[definition]=stmts) -> bool:
    ...
    csharp_ident_descr : NameMangling_IdentifierDescriptor = NameMangling_IdentifierDescriptor__WithNameEnv_Z7613F24B(NameMangling_IdentifierDescriptor_Create_Z48C5CCEF(arrow_126, lambda i_1, c_1, analyzer=analyzer, cg_options=cg_options, lang_name=lang_name, stmts=stmts: to_text(interpolate("_X%P()_", [i_1])) if (is_digit(c_1)) else (to_text(interpolate("_%P()_", [ord(c_1)])))), NameMangling_nameEnv(of_list(map_1(lambda tuple, analyzer=analyzer, cg_options=cg_options, lang_name=lang_name, stmts=stmts: tuple[1], global_scope), ObjectExpr125())))
    class ObjectExpr127:
        @property
        def Compare(self) -> Any:
            return lambda x_9, y_3: compare_primitives(x_9, y_3)
        
    antlr_lexer_ident_descr : NameMangling_IdentifierDescriptor = NameMangling_IdentifierDescriptor__WithNameEnv_Z7613F24B(NameMangling_IdentifierDescriptor_Create_Z48C5CCEF(lambda i_2, c_2, analyzer=analyzer, cg_options=cg_options, lang_name=lang_name, stmts=stmts: is_upper(c_2) if (i_2 == 0) else (True if (True if (is_upper(c_2)) else (c_2 == "_")) else (is_digit(c_2))), lambda i_3, c_3, analyzer=analyzer, cg_options=cg_options, lang_name=lang_name, stmts=stmts: c_3.upper() if (is_lower(c_3)) else (NameMangling_maskChar(ord("A"), ord("Z"), ord(c_3)) + "_" if (i_3 == 0) else (("_" + NameMangling_maskChar(ord("A"), ord("Z"), ord(c_3))) + "_"))), NameMangling_nameEnv(of_array(["EOF"], ObjectExpr127())))
    class ObjectExpr130:
        @property
        def Compare(self) -> Any:
    ...
    def arrow_150(analyzer: Analyzer=analyzer, cg_options: CodeGenOptions=cg_options, lang_name: str=lang_name, stmts: List[definition]=stmts) -> Iterable[Doc]:
        def arrow_149(_unit=None) -> Iterable[Doc]:
                    ...
                    def arrow_146(_unit=None) -> Iterable[Doc]:
                        def arrow_145(_unit=None) -> Iterable[Doc]:
                            def arrow_137(match_value_6: Tuple[str, Any]) -> Iterable[Doc]:
                                ...
                                def arrow_136(_unit=None) -> Iterable[Doc]:
                                    def arrow_135(match_value_7: Tuple[str, FSharpList[Tuple[str, monot]]]) -> Iterable[Doc]:
                                        ...
                                        return append_2(singleton_1(Doc_op_Addition_Z7CFFAC00(Doc_op_Multiply_Z7CFFAC00(word(to_text(interpolate("public partial record %P()", [ctor_name_0027]))), func_params), word(to_text(interpolate(": %P();", [typename_0027]))))), delay(arrow_134))
                                    
                                    return append_2(collect(arrow_135, to_array_1(match_value_6[1])), delay(lambda _unit=None: singleton_1(empty_2)))
                                
                                return append_2(singleton_1(word(to_text(interpolate("public partial interface %P() {  }", [typename_0027])))), delay(arrow_136))
                            ...
                            def arrow_144(_unit=None) -> Iterable[Doc]:
                                def arrow_143(match_value_9: Tuple[str, Shape]) -> Iterable[Doc]:
                                    ...
                                    fields_2 : FSharpList[Tuple[Doc, Doc]] = to_list(delay(lambda _unit=None: collect(lambda match_value_10: singleton_1((word(rename_field(match_value_10[0])), word(cg_type(match_value_10[1])))), to_array_1(shape.fields))))
                                    ...
                                    def arrow_141(_unit=None) -> Iterable[Doc]:
                                        nonlocal doc_ctor_wrap_funcs
                                        doc_ctor_wrap_funcs = cons((tparams_2, varname, typename_0027_1, fields_2, pattern_input_2[1]), doc_ctor_wrap_funcs)
                                        return empty_3()
                                    
                                    return append_2(singleton_1(Doc_op_Multiply_Z7CFFAC00(Doc_op_Multiply_Z7CFFAC00(Doc_op_Multiply_Z7CFFAC00(word(to_text(interpolate("public partial record %P()", [typename_0027_1]))), word(tparams_2)), func_params_1), word(";"))), delay(arrow_141))
            ...
            return append_2(singleton_1(word("using System.Collections.Generic;")), delay(arrow_148))
        
        return append_2(singleton_1(word("using Antlr4.Runtime;")), delay(arrow_149))
    
    file_constructors : Tuple[str, Doc] = (to_text(interpolate("%P().Constructor.", [lang_name])) + ".cs", vsep(to_list(delay(arrow_150))))
    ...
    if match_value_12 is not None:
        ...
        def cg_stmt(stmt: definition, analyzer: Analyzer=analyzer, cg_options: CodeGenOptions=cg_options, lang_name: str=lang_name, stmts: List[definition]=stmts) -> Doc:
            ...
            if stmt.tag == 2:
                ...
                idx_1 : int = 0
                def arrow_186(stmt: definition=stmt) -> Iterable[Doc]:
                    def arrow_185(match_value_4: Tuple[position, production_1]) -> Iterable[Doc]:
                        nonlocal current_pos
                        action_name_3 = None
                        idx : int = idx_1 or 0
                        action_name_3 = to_text(printf("%s_%i"))(ntname_1)(idx)
                        current_pos = match_value_4[0]
                        def arrow_183(_unit=None) -> Doc:
                            ...
                            used_slots : Any = empty_4(ObjectExpr155())
                            def cg_expr(scope_1: FSharpList[Tuple[str, str]], curr_expr_1: expr) -> DocBuilder_block_1[Doc]:
                                def arrow_173(scope_1: FSharpList[Tuple[str, str]]=scope_1, curr_expr_1: expr=curr_expr_1) -> DocBuilder_block_1[Doc]:
                                    nonlocal used_slots
                                    ...
                                    if match_value_1.tag == 6:
                                        ...
                                        if match_value_2 is not None:
                                            ...
                                            return DocBuilder_Builder__Return_1505(DocBuilder_cg, word(v_1)) if (length(match_value_1.fields[1].contents) == 0) else (DocBuilder_Builder__Return_1505(DocBuilder_cg, arrow_156()))
                                        
                                        else: 
                                            def arrow_157(_unit=None) -> Doc:
                                                raise UnboundVariable(match_value_1.fields[0])
                                            
                                            return DocBuilder_Builder__Return_1505(DocBuilder_cg, arrow_157())
                                        ...
                                        def arrow_167(_unit=None) -> Iterable[Tuple[str, str]]:
                                            def arrow_165(match_value_3: Tuple[str, monot]) -> Iterable[Tuple[str, str]]:
                                                arg_2 : str = match_value_3[0]
                                                return singleton_1((arg_2, mangle(csharp_ident_descr, arg_2)))
                                            
                                            return collect(arrow_165, match_value_1.fields[0])
                                        
                                        pattern_input : Tuple[Doc, FSharpList[Doc]] = DocBuilder_runCG(cg_expr(append_1(to_list(delay(arrow_167)), scope_1), match_value_1.fields[1]))
                                        def arrow_169(_unit=None) -> Doc:
                                        ...
                                        return DocBuilder_Builder__Return_1505(DocBuilder_cg, arrow_169())
                                    
                                    elif match_value_1.tag == 4:
                                        def arrow_172(_arg6: Doc) -> DocBuilder_block_1[Doc]:
                                        ...
                                        return DocBuilder_Builder__Bind_30A200B3(DocBuilder_cg, cg_expr(scope_1, match_value_1.fields[1]), arrow_172)
                                ...
                                return DocBuilder_Builder__Run_ZD0BB270(DocBuilder_cg, DocBuilder_Builder__Delay_Z3A9C5A06(DocBuilder_cg, arrow_173))
                            
                            snd : Tuple[Doc, FSharpList[Doc]] = DocBuilder_runCG(cg_expr(global_scope, curr_expr))
                            pattern_input_1 = (used_slots, snd)
                            def arrow_179(_unit=None) -> Doc:
                            ...
                            return Doc_op_Addition_Z7CFFAC00(Doc_op_Addition_Z7CFFAC00(arrow_179(), word("{")), Doc_op_RightShift_2AAA0F3C(vsep(of_array_1([empty_2, Doc_op_RightShift_2AAA0F3C(vsep(of_array_1([vsep(pattern_input_1[1][1]), Doc_op_Addition_Z7CFFAC00(Doc_op_Addition_Z7CFFAC00(word("$" + result_name), word("=")), Doc_op_Multiply_Z7CFFAC00(pattern_input_1[1][0], word(";")))])), 4), word("}")])), 12))
                        ...
                        return append_2(singleton_1(arrow_183()), delay(arrow_184))
                    
                    return collect(arrow_185, decl["define"])
                
                body_3 : Doc = align(vsep(map_indexed(lambda i_10, e_1, stmt=stmt: Doc_op_Addition_Z7CFFAC00(word(":") if (i_10 == 0) else (word("|")), e_1), to_list(delay(arrow_186)))))
        ...
        def arrow_189(analyzer: Analyzer=analyzer, cg_options: CodeGenOptions=cg_options, lang_name: str=lang_name, stmts: List[definition]=stmts) -> Iterable[Doc]:
            def arrow_188(match_value_13: Tuple[str, lexerule]) -> Iterable[Doc]:
            ...
            return collect(arrow_188, reverse(lexer_maps))
        
        lexer_defs : FSharpList[Doc] = to_list(delay(arrow_189))
        start_mangled : str = cg_symbol(symbol(1, "start"))
        def arrow_200(analyzer: Analyzer=analyzer, cg_options: CodeGenOptions=cg_options, lang_name: str=lang_name, stmts: List[definition]=stmts) -> Iterable[Doc]:
            def arrow_199(_unit=None) -> Iterable[Doc]:
                def arrow_198(_unit=None) -> Iterable[Doc]:
                    def arrow_197(_unit=None) -> Iterable[Doc]:
                        def arrow_193(match_value_14: Tuple[str, str, str, FSharpList[Tuple[Doc, Doc]], Doc]) -> Iterable[Doc]:
                        ...
                        def arrow_196(_unit=None) -> Iterable[Doc]:
                            def arrow_195(_unit=None) -> Iterable[Doc]:
                                ...
                                return append_2(singleton_1(word(arrow_194())), delay(lambda _unit=None: append_2(singleton_1(file_grammar), delay(lambda _unit=None: lexer_defs))))
                            
                            return append_2(singleton_1(word("}")), delay(arrow_195))
                        
                        return append_2(collect(arrow_193, doc_ctor_wrap_funcs), delay(arrow_196))
                    
                    return append_2(singleton_1(word("@members {")), delay(arrow_197))
                
                return append_2(singleton_1(word("options { language = CSharp; }")), delay(arrow_198))
            
            return append_2(singleton_1(word(to_text(interpolate("grammar %P();", [lang_name])))), delay(arrow_199))
        
        return [(lang_name + ".g4", vsep(to_list(delay(arrow_200)))), file_constructors]
