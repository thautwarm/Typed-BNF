...
from typing import (TypeVar, Any, Generic, List, Callable, Tuple, Optional)
...
class Cell_1(Generic[a_4]):
    ...
    def __str__(self) -> str:
        ...
        if Cell_1__get_IsNull(__):
            ...
            copy_of_struct : a = Cell_1__get_Get(__)
            return to_string(copy_of_struct)
        
    

Cell_1_reflection = expr_3
...
def expr__transform_children_z51b8244a(this: expr, op_dereference: Callable[[expr], expr]) -> expr:
    def arrow_33(this: expr=this, op_dereference: Callable[[expr], expr]=op_dereference) -> node:
    ...
    return expr_with_node(this, arrow_33())
...
def monot__find_any_children_z23d07ce9(this: monot, predicate: Callable[[monot], bool]) -> bool:
    if (this.tag == 4) or (this.tag == 0):
        ...
        if exists(lambda tupled_arg, this=this, predicate=predicate: predicate(tupled_arg[1]), this.fields[0]):
            return True
...
def monot__transform_children_z2cab662a(this: monot, ap: Callable[[monot], monot]) -> monot:
    ...
    if pattern_matching_result == 0:
        ...
        return monot(3, map(lambda ab, this=this, ap=ap: (ab[0], ap(ab[1])), this.fields[0]), ap(this.fields[1]))
...
def monot__apply_to_children_z6a62bcbf(this: monot, op_dereference: Callable[[monot], None]) -> None:
    if (this.tag == 4) or (this.tag == 0):
        ...
        def arrow_40(tupled_arg: Tuple[str, monot], this: monot=this, op_dereference: Callable[[monot], None]=op_dereference) -> None:
            op_dereference(tupled_arg[1])
        
        iterate(arrow_40, this.fields[0])
