...
def expr__transform_children_z51b8244a(this: expr, op_dereference: Callable[[expr], expr]) -> expr:
    def arrow_29(this: expr=this, op_dereference: Callable[[expr], expr]=op_dereference) -> node:
    ...
    return expr_with_node(this, arrow_29())
