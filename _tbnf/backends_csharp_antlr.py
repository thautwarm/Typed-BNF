...
def codegen(analyzer: Analyzer, _arg1: CodeGenOptions, stmts: List[definition]) -> List[Tuple[str, Doc]]:
    ...
    def arrow_118(i: int, c: str, analyzer=analyzer, _arg1=_arg1, stmts=stmts) -> bool:
    ...
    if match_value_6 is not None:
        ...
        def cg_stmt(stmt: definition, analyzer=analyzer, _arg1=_arg1, stmts=stmts) -> Doc:
            ...
            if stmt.tag == 2:
                ...
                idx_1 : int = 0
                def arrow_148(stmt=stmt) -> Any:
                    def arrow_147(match_value_4: Tuple[position, production_1]) -> Any:
                        nonlocal current_pos
                        action_name_3 = None
                        idx : int = idx_1 or 0
                        action_name_3 = to_text(printf("%s_%i"))(ntname_1)(idx)
                        current_pos = match_value_4[0]
                        def arrow_145(_unit=None) -> Doc:
                            ...
                            used_slots : Any = empty_3(ObjectExpr125())
                            def cg_expr(scope_1: FSharpList[Tuple[str, str]], curr_expr_1: expr) -> DocBuilder_block_1[Doc]:
                                def arrow_142(scope_1=scope_1, curr_expr_1=curr_expr_1) -> DocBuilder_block_1[Doc]:
                                    nonlocal used_slots
                                    ...
                                    if match_value_1.tag == 6:
                                        ...
                                        if match_value_2 is not None:
                                            ...
                                            return DocBuilder_Builder__Return_1505(DocBuilder_cg, word(v_1)) if (length(match_value_1.fields[1].contents) == 0) else (DocBuilder_Builder__Return_1505(DocBuilder_cg, arrow_127()))
                                        
                                        else: 
                                            def arrow_128(_unit=None) -> Doc:
                                                raise UnboundVariable(match_value_1.fields[0])
                                            
                                            return DocBuilder_Builder__Return_1505(DocBuilder_cg, arrow_128())
                                        ...
                                        def arrow_131(_unit=None) -> Any:
                                            def arrow_130(match_value_3: Tuple[str, monot]) -> Any:
                                                arg_2 : str = match_value_3[0]
                                                return singleton_1((arg_2, mangle(csharp_ident_descr, arg_2)))
                                            
                                            return collect(arrow_130, match_value_1.fields[0])
                                        
                                        pattern_input : Tuple[Doc, FSharpList[Doc]] = DocBuilder_runCG(cg_expr(append_1(to_list(delay(arrow_131)), scope_1), match_value_1.fields[1]))
                                        ...
                                        def arrow_133(_arg7: Doc) -> DocBuilder_block_1[Doc]:
                                        ...
                                        return DocBuilder_Builder__Bind_Z300482AD(DocBuilder_cg, cg_expr(scope_1, match_value_1.fields[1]), arrow_133)
                                ...
                                return DocBuilder_Builder__Run_72B9C953(DocBuilder_cg, DocBuilder_Builder__Delay_Z6CB7AF07(DocBuilder_cg, arrow_142))
                            
                            snd : Tuple[Doc, FSharpList[Doc]] = DocBuilder_runCG(cg_expr(global_scope, curr_expr))
                            pattern_input_1 = (used_slots, snd)
                            def arrow_143(_unit=None) -> Doc:
                            ...
                            return Doc_op_Addition_Z7CFFAC00(Doc_op_Addition_Z7CFFAC00(arrow_143(), word("{")), Doc_op_RightShift_2AAA0F3C(vsep(of_array_1([empty_2, Doc_op_RightShift_2AAA0F3C(vsep(of_array_1([vsep(pattern_input_1[1][1]), Doc_op_Addition_Z7CFFAC00(Doc_op_Addition_Z7CFFAC00(word("$" + result_name), word("=")), Doc_op_Multiply_Z7CFFAC00(pattern_input_1[1][0], word(";")))])), 4), word("}")])), 12))
                        
                        def arrow_146(_unit=None) -> Any:
                            nonlocal idx_1
                            idx_1 = (idx_1 + 1) or 0
                            return empty_4()
                        
                        return append_2(singleton_1(arrow_145()), delay(arrow_146))
                    
                    return collect(arrow_147, decl["define"])
                
                body_3 : Doc = align(vsep(map_indexed(lambda i_10, e_1, stmt=stmt: Doc_op_Addition_Z7CFFAC00(word(":") if (i_10 == 0) else (word("|")), e_1), to_list(delay(arrow_148)))))
        ...
        def arrow_150(analyzer=analyzer, _arg1=_arg1, stmts=stmts) -> Any:
            def arrow_149(match_value_7: Tuple[str, lexerule]) -> Any:
            ...
            return collect(arrow_149, reverse(lexer_maps))
        
        lexer_defs : FSharpList[Doc] = to_list(delay(arrow_150))
        start_mangled : str = cg_symbol(symbol(1, "start"))
        def arrow_154(analyzer=analyzer, _arg1=_arg1, stmts=stmts) -> Any:
            def arrow_153(_unit=None) -> Any:
                def arrow_152(_unit=None) -> Any:
                    def arrow_151(_unit=None) -> str:
                    ...
                    return append_2(singleton_1(word(arrow_151())), delay(lambda _unit=None: append_2(singleton_1(file_grammar), delay(lambda _unit=None: lexer_defs))))
                
                return append_2(singleton_1(word("options { language = CSharp; }")), delay(arrow_152))
            
            return append_2(singleton_1(word(to_text(interpolate("grammar %P();", [lang_name])))), delay(arrow_153))
        
        return [(lang_name + ".g4", vsep(to_list(delay(arrow_154))))]
