...
from fable_modules.fable_library.list import (empty, FSharpList, map as map_1, is_empty, head, tail, append as append_1, singleton, to_array, fold, of_array as of_array_1, cons, map_indexed, length, reverse)
...
from .FableSedlex.code_gen import (Doc, parens, word, vsep, empty as empty_2, align, Doc_op_Addition_Z7CFFAC00, seplist, Doc_op_Multiply_Z7CFFAC00, Doc_op_RightShift_2AAA0F3C, bracket)
from .grammar import (symbol, position, lexerule, _007CTTuple_007C__007C, monot, monot__prune, TConst_token, production as production_1, expr, node, definition)
from .utils import (NameMangling_IdentifierDescriptor__WithNameEnv_Z4088684A, NameMangling_nameEnv, NameMangling_IdentifierDescriptor_Create_Z48C5CCEF, is_lower, is_upper, is_unicode, is_digit, NameMangling_IdentifierDescriptor, NameMangling_maskChar, NameMangling_mangle, escape_string_single_quoted, i_to_u4, escape_string, DocBuilder_Builder__Run_72B9C953, DocBuilder_Builder__Delay_Z6CB7AF07, DocBuilder_Builder__Return_1505, DocBuilder_cg, DocBuilder_Builder__Bind_Z300482AD, DocBuilder_block_1, DocBuilder_runCG, DocBuilder_Builder__Combine_Z44B4C520, DocBuilder_Builder__Yield_417FD60, DocBuilder_Builder__ReturnFrom_72B9C953, DocBuilder_Builder__For_4C40856C)

a_ = TypeVar("a_")

b_ = TypeVar("b_")

CSharpKeywords = ["__arglist", "__makeref", "__reftype", "__refvalue", "abstract", "as", "base", "bool", "break", "byte", "case", "catch", "char", "checked", "class", "const", "continue", "decimal", "default", "delegate", "do", "double", "else", "enum", "event", "explicit", "extern", "false", "finally", "fixed", "float", "for", "foreach", "goto", "if", "implicit", "in", "int", "interface", "internal", "is", "lock", "long", "namespace", "new", "null", "object", "operator", "out", "override", "params", "private", "protected", "public", "readonly", "ref", "return", "sbyte", "sealed", "short", "sizeof", "stackalloc", "static", "string", "struct", "switch", "this", "throw", "true", "try", "typeof", "uint", "ulong", "unchecked", "unsafe", "ushort", "using", "virtual", "volatile", "void", "while"]
...
def codegen(analyzer: Analyzer, _arg1: CodeGenOptions, stmts: List[definition]) -> List[Tuple[str, Doc]]:
    ...
    abandoned_names : Any = of_array(append(["result"], CSharpKeywords, None), ObjectExpr107())
    class ObjectExpr108:
        @property
        def Compare(self) -> Any:
    ...
    def arrow_110(i: int, c: str, analyzer=analyzer, _arg1=_arg1, stmts=stmts) -> bool:
    ...
    csharp_ident_descr : NameMangling_IdentifierDescriptor = NameMangling_IdentifierDescriptor__WithNameEnv_Z4088684A(NameMangling_IdentifierDescriptor_Create_Z48C5CCEF(arrow_110, lambda i_1, c_1, analyzer=analyzer, _arg1=_arg1, stmts=stmts: to_text(interpolate("_X%P()_", [i_1])) if (is_digit(c_1)) else (to_text(interpolate("_%P()_", [ord(c_1)])))), NameMangling_nameEnv(of_list(map_1(lambda tuple, analyzer=analyzer, _arg1=_arg1, stmts=stmts: tuple[1], global_scope), ObjectExpr109())))
    class ObjectExpr111:
        @property
        def Compare(self) -> Any:
            return lambda x_3, y_3: compare_primitives(x_3, y_3)
        
    antlr_lexer_ident_descr : NameMangling_IdentifierDescriptor = NameMangling_IdentifierDescriptor__WithNameEnv_Z4088684A(NameMangling_IdentifierDescriptor_Create_Z48C5CCEF(lambda i_2, c_2, analyzer=analyzer, _arg1=_arg1, stmts=stmts: is_upper(c_2) if (i_2 == 0) else (True if (True if (is_upper(c_2)) else (c_2 == "_")) else (is_digit(c_2))), lambda i_3, c_3, analyzer=analyzer, _arg1=_arg1, stmts=stmts: c_3.upper() if (is_lower(c_3)) else (NameMangling_maskChar(ord("A"), ord("Z"), ord(c_3)) + "_" if (i_3 == 0) else (("_" + NameMangling_maskChar(ord("A"), ord("Z"), ord(c_3))) + "_"))), NameMangling_nameEnv(of_array(["EOF"], ObjectExpr111())))
    class ObjectExpr112:
        @property
        def Compare(self) -> Any:
            return lambda x_4, y_4: compare_primitives(x_4, y_4)
        
    antlr_grammar_ident_descr : NameMangling_IdentifierDescriptor = NameMangling_IdentifierDescriptor__WithNameEnv_Z4088684A(NameMangling_IdentifierDescriptor_Create_Z48C5CCEF(lambda i_4, c_4, analyzer=analyzer, _arg1=_arg1, stmts=stmts: is_lower(c_4) if (i_4 == 0) else (True if (True if (is_lower(c_4)) else (c_4 == "_")) else (is_digit(c_4))), lambda _arg1_1, c_5, analyzer=analyzer, _arg1=_arg1, stmts=stmts: c_5.lower() if (is_upper(c_5)) else (("_" + NameMangling_maskChar(ord("a"), ord("z"), ord(c_5))) + "_")), NameMangling_nameEnv(of_array(["start"], ObjectExpr112())))
    ...
    def _cg_type(t: monot, analyzer=analyzer, _arg1=_arg1, stmts=stmts) -> str:
        ...
        if pattern_matching_result == 0:
            ...
            return ("System.Func\u003c" + join(", ", append_1(map_1(_cg_type, args), singleton(_cg_type(r))))) + "\u003e"
    ...
    def mk_lexer(def_: lexerule, analyzer=analyzer, _arg1=_arg1, stmts=stmts) -> str:
        if def_.tag == 9:
    ...
    def mk_lexer_debug(def__6: lexerule, analyzer=analyzer, _arg1=_arg1, stmts=stmts) -> str:
        ...
        if def__6.tag == 9:
            ...
            if not is_empty(def__6.fields[0]):
                return fold(lambda a_2, b_1, def__6=def__6: to_text(interpolate("por(%P(), %P())", [a_2, b_1])), op_dereference(head(def__6.fields[0])), map_1(mk_lexer_debug, tail(def__6.fields[0])))
    ...
    def simplify_lexerule(x_14: lexerule, analyzer=analyzer, _arg1=_arg1, stmts=stmts) -> lexerule:
    ...
    def _must_be_atom_rule(x_19_mut: lexerule, analyzer=analyzer, _arg1=_arg1, stmts=stmts) -> lexerule:
        while True:
            (x_19,) = (x_19_mut,)
    ...
    def parens_if_lor(x_25: lexerule, analyzer=analyzer, _arg1=_arg1, stmts=stmts) -> Doc:
    ...
    if match_value_6 is not None:
        ...
        def cg_stmt(stmt: definition, analyzer=analyzer, _arg1=_arg1, stmts=stmts) -> Doc:
            ...
            if stmt.tag == 2:
                ...
                idx_1 : int = 0
                def arrow_131(stmt=stmt) -> Any:
                    def arrow_130(match_value_4: Tuple[position, production_1]) -> Any:
                        nonlocal current_pos
                        action_name_3 = None
                        idx : int = idx_1 or 0
                        action_name_3 = to_text(printf("%s_%i"))(ntname_1)(idx)
                        current_pos = match_value_4[0]
                        def arrow_128(_unit=None) -> Doc:
                            ...
                            used_slots : Any = empty_3(ObjectExpr113())
                            def cg_expr(scope_1: FSharpList[Tuple[str, str]], curr_expr_1: expr) -> DocBuilder_block_1[Doc]:
                                def arrow_122(scope_1=scope_1, curr_expr_1=curr_expr_1) -> DocBuilder_block_1[Doc]:
                                    nonlocal used_slots
                                    ...
                                    if match_value_1.tag == 6:
                                        ...
                                        if match_value_2 is not None:
                                            ...
                                            return DocBuilder_Builder__Return_1505(DocBuilder_cg, word(v_1)) if (length(match_value_1.fields[1].contents) == 0) else (DocBuilder_Builder__Return_1505(DocBuilder_cg, arrow_114()))
                                        
                                        else: 
                                            def arrow_115(_unit=None) -> Doc:
                                                raise UnboundVariable(match_value_1.fields[0])
                                            
                                            return DocBuilder_Builder__Return_1505(DocBuilder_cg, arrow_115())
                                        ...
                                        return DocBuilder_Builder__Bind_Z300482AD(DocBuilder_cg, cg_expr(scope_1, match_value_1.fields[0]), lambda _arg6: DocBuilder_Builder__Return_1505(DocBuilder_cg, Doc_op_Multiply_Z7CFFAC00(Doc_op_Multiply_Z7CFFAC00(_arg6, word(".")), word(match_value_1.fields[1]))))
                                        ...
                                        def arrow_117(_unit=None) -> Any:
                                            def arrow_116(match_value_3: Tuple[str, monot]) -> Any:
                                                arg_2 : str = match_value_3[0]
                                                return singleton_1((arg_2, mangle(csharp_ident_descr, arg_2)))
                                            
                                            return collect(arrow_116, match_value_1.fields[0])
                                        
                                        pattern_input : Tuple[Doc, FSharpList[Doc]] = DocBuilder_runCG(cg_expr(append_1(to_list(delay(arrow_117)), scope_1), match_value_1.fields[1]))
                                        def arrow_118(_unit=None) -> Doc:
                                            ...
                                            anns : FSharpList[Doc] = map_1(lambda tupled_arg: word((cg_type(tupled_arg[1]) + " ") + tupled_arg[0]), match_value_1.fields[0])
                                            return parens(vsep(of_array_1([Doc_op_Multiply_Z7CFFAC00(parens(seplist(word(", "), anns)), word("=\u003e")), Doc_op_RightShift_2AAA0F3C(body, 4)])))
                                        
                                        return DocBuilder_Builder__Return_1505(DocBuilder_cg, arrow_118())
                                    
                                    elif match_value_1.tag == 4:
                                        def arrow_119(_arg7: Doc) -> DocBuilder_block_1[Doc]:
                                            m_name : str = mangle(csharp_ident_descr, match_value_1.fields[0])
                                            return DocBuilder_Builder__Combine_Z44B4C520(DocBuilder_cg, DocBuilder_Builder__Yield_417FD60(DocBuilder_cg, Doc_op_Addition_Z7CFFAC00(Doc_op_Addition_Z7CFFAC00(word(m_name), word("=")), Doc_op_Multiply_Z7CFFAC00(_arg7, word(";")))), DocBuilder_Builder__Delay_Z6CB7AF07(DocBuilder_cg, lambda _unit=None: DocBuilder_Builder__ReturnFrom_72B9C953(DocBuilder_cg, cg_expr(cons((match_value_1.fields[0], m_name), scope_1), match_value_1.fields[2]))))
                                        
                                        return DocBuilder_Builder__Bind_Z300482AD(DocBuilder_cg, cg_expr(scope_1, match_value_1.fields[1]), arrow_119)
                                    
                                    elif match_value_1.tag == 2:
                                        return DocBuilder_Builder__Bind_Z300482AD(DocBuilder_cg, DocBuilder_Builder__Run_72B9C953(DocBuilder_cg, DocBuilder_Builder__Delay_Z6CB7AF07(DocBuilder_cg, lambda _unit=None: DocBuilder_Builder__For_4C40856C(DocBuilder_cg, match_value_1.fields[0], lambda _arg8: DocBuilder_Builder__ReturnFrom_72B9C953(DocBuilder_cg, cg_expr(scope_1, _arg8))))), lambda _arg9: DocBuilder_Builder__Return_1505(DocBuilder_cg, Doc_op_Addition_Z7CFFAC00(Doc_op_Addition_Z7CFFAC00(Doc_op_Addition_Z7CFFAC00(Doc_op_Addition_Z7CFFAC00(word("new"), word(cg_type(curr_expr_1.t))), word("{")), seplist(word(","), _arg9)), word("}"))))
                                        ...
                                        return DocBuilder_Builder__Bind_Z300482AD(DocBuilder_cg, DocBuilder_Builder__Run_72B9C953(DocBuilder_cg, DocBuilder_Builder__Delay_Z6CB7AF07(DocBuilder_cg, lambda _unit=None: DocBuilder_Builder__For_4C40856C(DocBuilder_cg, match_value_1.fields[0], lambda _arg10: DocBuilder_Builder__ReturnFrom_72B9C953(DocBuilder_cg, cg_expr(scope_1, _arg10))))), lambda _arg11: DocBuilder_Builder__Return_1505(DocBuilder_cg, parens(seplist(word(", "), _arg11)))) if (match_value_1.tag == 1) else (DocBuilder_Builder__Bind_Z300482AD(DocBuilder_cg, cg_expr(scope_1, match_value_1.fields[0]), lambda _arg3: DocBuilder_Builder__Bind_Z300482AD(DocBuilder_cg, DocBuilder_Builder__Run_72B9C953(DocBuilder_cg, DocBuilder_Builder__Delay_Z6CB7AF07(DocBuilder_cg, lambda _unit=None: DocBuilder_Builder__For_4C40856C(DocBuilder_cg, match_value_1.fields[1], lambda _arg4: DocBuilder_Builder__ReturnFrom_72B9C953(DocBuilder_cg, cg_expr(scope_1, _arg4))))), lambda _arg5: DocBuilder_Builder__Return_1505(DocBuilder_cg, Doc_op_Multiply_Z7CFFAC00(_arg3, parens(seplist(word(", "), _arg5)))))))
                                    
                                
                                return DocBuilder_Builder__Run_72B9C953(DocBuilder_cg, DocBuilder_Builder__Delay_Z6CB7AF07(DocBuilder_cg, arrow_122))
                            
                            snd : Tuple[Doc, FSharpList[Doc]] = DocBuilder_runCG(cg_expr(global_scope, curr_expr))
                            pattern_input_1 = (used_slots, snd)
                            def arrow_127(_unit=None) -> Doc:
                            ...
                            return Doc_op_Addition_Z7CFFAC00(Doc_op_Addition_Z7CFFAC00(arrow_127(), word("{")), Doc_op_RightShift_2AAA0F3C(vsep(of_array_1([empty_2, Doc_op_RightShift_2AAA0F3C(vsep(of_array_1([vsep(pattern_input_1[1][1]), Doc_op_Addition_Z7CFFAC00(Doc_op_Addition_Z7CFFAC00(word("$" + result_name), word("=")), Doc_op_Multiply_Z7CFFAC00(pattern_input_1[1][0], word(";")))])), 4), word("}")])), 12))
                        
                        def arrow_129(_unit=None) -> Any:
                            nonlocal idx_1
                            idx_1 = (idx_1 + 1) or 0
                            return empty_4()
                        
                        return append_2(singleton_1(arrow_128()), delay(arrow_129))
                    
                    return collect(arrow_130, decl["define"])
                
                body_3 : Doc = align(vsep(map_indexed(lambda i_10, e_1, stmt=stmt: Doc_op_Addition_Z7CFFAC00(word(":") if (i_10 == 0) else (word("|")), e_1), to_list(delay(arrow_131)))))
        ...
        def arrow_135(analyzer=analyzer, _arg1=_arg1, stmts=stmts) -> Any:
            def arrow_134(match_value_7: Tuple[str, lexerule]) -> Any:
            ...
            return collect(arrow_134, reverse(lexer_maps))
        
        lexer_defs : FSharpList[Doc] = to_list(delay(arrow_135))
        start_mangled : str = cg_symbol(symbol(1, "start"))
        def arrow_139(analyzer=analyzer, _arg1=_arg1, stmts=stmts) -> Any:
            def arrow_138(_unit=None) -> Any:
                def arrow_137(_unit=None) -> Any:
                    def arrow_136(_unit=None) -> str:
                    ...
                    return append_2(singleton_1(word(arrow_136())), delay(lambda _unit=None: append_2(singleton_1(file_grammar), delay(lambda _unit=None: lexer_defs))))
                
                return append_2(singleton_1(word("options { language = CSharp; }")), delay(arrow_137))
            
            return append_2(singleton_1(word(to_text(interpolate("grammar %P();", [lang_name])))), delay(arrow_138))
        
        return [(lang_name + ".g4", vsep(to_list(delay(arrow_139))))]
